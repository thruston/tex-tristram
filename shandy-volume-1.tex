...
\stick{heard of the animal spirits, as how they are}
...
\stick{near nine kalendar months as any husband} 
...
My Lord,\\[-24pt]
\lettrine{\rlap{\normalsize “}\lower-12pt\hbox{\normalsize “ }I}{ \ls{maintain}} this to
be a dedication,\break
notwithstanding its singularity in\break
\stick{“\kern 3pt the three great essentials of matter,}\pb
\stick{“\kern 3pt form, and place: I beg, therefore, you}
\stick{“\kern 3pt will accept it as such, and that you will}
\stick{“\kern 3pt permit me to lay it, with the most re-}
\stick{“\kern 3pt spectful humility, at your Lordship’s}
\stick{“\kern 3pt feet\tsk  when you are upon them,\tsk}
\stick{“\kern 3pt which you can be when you please;\tsk}
\stick{“\kern 3pt and that is, my Lord, when ever there}
\stick{“\kern 3pt is occasion for it, and I will add, to the}
\stick{“\kern 3pt best purposes too. I have the honour}
\stick{“\kern 3pt to be,\hfill}
...
\stick{verty, and sickness, and affliction dwelt}\break together.
...
ranks of\pb\stick{people, of which every body has a share;”}
...
good fortune to pop upon the\pb very thing I wanted before I had read
...
For, if he is a man of the least spirit, he\pb will have fifty
...
and endless genealogies, which justice ever\pb and anon calls him back
to stay the\break
...
\noindent\enspace
\begin{story}{\gothic{\Large And this Indenture further}} 
    \gothic{\Large witnesseth,}\quad That the said \textit{Walter Shandy}, merchant, 
...
Turner}, Esqrs.\@ the above-\break named trustees, \etc \etc.\tsk\gothic{\Large to
wit},\tsk\break  That in case it should hereafter so fall out, chance, happen, or
...
\gothic{\Large That is to say},\tsk  That the said sum of one hundred and twenty pounds shall be paid
...
and there enceint and pregnant with,\tsk\pb  
    ...
    ed,\tsk  shall think fit.\tsk \gothic{\Large And this In-}\break
    \gothic{\Large denture further witnesseth,}\break
    ...
    uses into possession,\tsk  \gothic{\Large All} that\break
    ...
    ments whatsoever.\tsk  \gothic{\Large And also} the\break
...
\stick{“ was to lay in, (if she chose it) in}
\stick{“ \textit{London.}”\hfill}
...
\stick{The fact was this, That in the latter end} of \textit{September} 1717, which was the year before I
...
\stick{every shilling of it have been saved;\tsk}\break
\stick{then what vexed him more than every}\pb 
...
\vspace\parskip
\noindent
\stick{\indent For the next two whole stages, no}
...
\stick{but this old woman’s only.\tsk  Now this I}\pb
...
\stick{some emotion, as he walked across the}\break room, 
...
\vspace\parskip
\noindent
\stick{\hfil Another political reason which prompt-}
\stick{ed my father so strongly to guard against}\pb 
...
\stick{for which reason, he would often declare,}\pb 
...
\vbox{\openup 2pt\halign{\kern 92pt\textsc{#}\hss\cr
A.\@ \ls{Le Moyne},\cr
L.\@ \ls{De Romigny},\cr
\ls{De Marcilly}.\cr}}

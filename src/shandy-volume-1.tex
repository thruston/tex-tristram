...
Now the \ls{\textsc{Hobby-Horse}} which my\break
uncle \textit{Toby} always rode upon, was, in my\break
opinion, an \ls{\textsc{Hobby-Horse}} well worth\break giving
...
\stick{\ls{\textsc{Hobby-Horse}} or no: But as the Philo-}
...
no other argument to prove his \ls{\textsc{Hobby-}}
\ls{\textsc{Horse}} was a \ls{\textsc{Hobby-Horse}} indeed, 

...
\lettrine{H}{\,\ls{aving}}, \textit{a priori}, intended
...
\lettrine{T}{\,\ls{hough}} the Corporal had been as good
...
\lettrine{S}{\,\ls{he}} cannot, quoth my uncle
...
her shop\tsk Tom set out\tsk counting the matter thus within\etp\catch{himself,} himself, as he walk’d
...
together; my uncle Toby’s kindled as one\catch{lamp} lamp does at another; and taking hold of
...
\lettrine{W}{\,\ls{hen}} Tom, an’ please
...
\lettrine{A}{\lss{ll}} womankind, continued Trim,
...
\lettrine{N}{\,\ls{ow}}, for what the world thinks of
...
\lettrine{\Tsk {\normalsize\lower -11pt \hbox{\lqq }\ }N}{\,\lss{ow}}\nobreak
...
\lettrine{U}{\,\ls{pon}} looking back from the end\break of the last chapter, and surveying
...
\lettrine{N}{\,\ls{ow}} in ordinary cases, that is, when
...
at once; and having tried the edge\catch{of} of it upon the palm of my hand, without
...
more abus’d, cursed, criticis’d, and confounded, and had more\catch{mystic} mystic heads shaken at
...
just the contrary, inas-\catch{much} much as the dirtier the fellow is, the
...
\lettrine{T}{\,\lss{he}} fifteenth chapter is come at
...
\lettrine{W}{\,\lss{hen}} my uncle Toby and the\break
...
obeyed them. The first was not an act of his will\tsk the second
...
\lettrine{M}{\,\ls{rs}}.\@ Bridget had pawn’d
...
\vfill\rightline{\ls{THE}}\eject\null
\section{{\addfontfeature{LetterSpace=20}THE\quad INVOCATION}.}


\lettrine{G}{\ls{entle}} Spirit of sweetest hu\-mour, who erst did sit upon the easy pen of my
...
was moreover filch’d from me at Sienna, and\catch{twice} twice that
...
have sifted out his history,\catch{had} had not poor Maria taken such
...
\lettrine{W}{\,\ls{hen}} we have got to the end of this
...
matter to work after its own way.\patch{My}
...
\stick{\lqq \textit{love, is making it}.\,”\hfill}\patch{\tsk I}
...
\lettrine{N}{\,\ls{ow}} there are such an infinitude of
...
to the other. She\catch{had} had peeped into \textit{Wharton}
...
\stick{\indent \lqq \tsh Could he lie on both sides}
...
\lettrine{\kern -3pt\Tsk A}{\ls{nd}} here is the
...
would chuse to have such a thing by one at least\tsh\patch{It}
...
\lettrine{N}{\,\ls{ow}} my uncle Toby had one
...
\lettrine{T}{\,\ls{here}} will be just time, whilst\break my
...
\stick{\lqq lust;” but that every evil and dis-}
...
\lettrine{\hbox to 42pt{\kern -.06em\Tsk T}}{\,\ls{hat}} provision should
be\break

...
with,\tsh first in my uncle \textit{Toby}’s face\tsk then in
his\tsk then up\tsk then down\tsk then\catch{east} east\tsk east and by
east, and so on,\tsh coasting it along by the plinth of the
...
indifferent\catch{\lower1pt\hbox{o}r} or not indifferent, just
as the case happens?
...
would have been enough, had \textit{Hymen} been taking a jaunt
that way, to have frightened him out of the country; but when
\textit{Obadiah} accelerated his motion, and from a plain trot
assayed to prick his coach-horse into a full gallop\tsk by
heaven! Sir,\tsk the jingle was incredible.
...
A sudden trampling in the room above, \tight{near my mother’s
...
wish he was shot\tsh
I wish\catch{all} all the devils in hell had him for a blockhead\tsh
...
\stick{soliloquy last night?\tsk Oh, against all rule,}\break
...
infinitely short of the force and spirit\catch{of}
...
\lettrine{\null\hbox to 32pt{\Tsk}B}{\ls{less}} my soul!\tsh my
poor\break mistress is ready to faint,\tsh\break
...
would end in his new\catch{invented} invented \textit{forceps}, he thrust his hand into the
...
suffi-\catch{ciently} ciently arm’d, or the rivet wants closing\tsk or else
...
\lettrine{\Tsk A}{\!\ls{nd}} pray, good woman, after all, will
...
\lettrine{I}{\,t} is two hours, and ten minutes,\tsk\break
...
\stick{\tight{breeches,\tsk with a thousand other inquiries}}
and disputes about
...
\bgroup\itshape\fontsize{9.5}{14}\selectfont % enlargethispage\baselineskip
\footnote{Vid.\@ Locke}\ For if you will turn your eyes inwards\break
upon your mind, {\upshape continued my father}, and\break
observe attentively, you will perceive, brother, 
that whilst you and I are talking together,
and thinking and smoaking our pipes:
...
our\egroup\catch{\smallit{think-}}
...
\lettrine{\Tsk W}{\,\ls{hat}} a conjuncture was\break
...
smoak-jack;\break
\tsh the funnel unswept, and the ideas\catch{whirling}
...
\stick{\tight{he, whose infinite wisdom which dispenses}}
...
looks, and such a de-\catch{gree} gree of inveteracy in their manner of kicking it, as if the
...
his hand in such a condition?\tsk nay, lay \stick{your hands
...
saved his honour for ever.\patch{\tsk Incon-}
...
\lettrine{\hbox to 32pt{\Tsk}\lower-10pt\hbox{\large\lqq}B}{\ls{ecause}},\,\lower2pt\hbox{”}
quoth my grand-\break mother, repeating the\break
...
By the same learned chain of reason-\catch{ing} ing my father stood up
...
felt a strong impulse, with a mighty and un-\catch{resistible} resistible call
...
distresses and domestic misadventures crouding in upon me\catch{thick} thick
...
oath of confu-\catch{sion} sion was levell’d at my uncle
...
\lettrine{N}{\,o} matter,\tsh as an appendage to\break
...
not\catch{open} open \enlargethispage\baselineskip
...
of \stick{them in his eight, ninth, and tenth decads,}
which I own seem

...
in practice\catch{throughout} throughout the known world, I am confident my own way
...
the elbow of it, I look up\tsh\catch{catching} catching the idea, even sometimes before it half way
reaches me\tsh
...
\stick{I think there was no occasion for it.\enspace}
...
worth\tsh and to wear a mask which was bald,\catch{or} 
...
\dropcap{\lower-10pt\hbox{\large \lqq}I}{t} is with Love as with
...
Of all mortal, and immortal men too, if you please, who ever soliloquized upon\catch{this} this
...
\dropcap{W}{hy} weavers, gardeners, and
...
\lqq up a torch in my Jenny’s\tsk\patch{\tsk The}
...
\initial{I}{Wish} my uncle Toby had been
...
by your worships into the secret\tsh\patch{But}
...
one would think I took a pleasure in run-\sic\catch{ing} 
...
it but two months ago, that in a\catch{fit} fit of laughter, on seeing a
...
\dropcap{M}{y} uncle Toby and the corporal
...
when\break
the house and all the furniture is her own.\patch{There}
...
come to nothing)\tsh so much the worse\catch{for}
...
and having gently, and\catch{with} with both her hands, drawn it
...
charity, she\catch{was} was in, and bore towards her mistress that night. In
...
Bridget to\catch{bring} bring her up a couple of fresh candles and leave
...
\dropcap{M}{y} uncle Toby’s head at
...
this nature, as it is the second blow, happen at what distance of\catch{time} time it will,
...
\dropcap{N}{ow} as widow Wadman did love
...
much this, and that, and t’other, that I cannot eat my\catch{breakfast}
...
\tsh O Tristram! Tristram! cried Jenny.\patch{O Jenny!}
...
\dropcap{W}{hich} shews, let your reverences and worships say what you
will of it (for as for \textit{thinking}\tsk all
who \textit{do} think\tsk think pretty much alike
both upon it and other matters)\tsh\catch{\textsc{Love}} 
\textsc{Love} is certainly, at least alphabetically speaking, one of the most

\medskip
\vbox{\halign{\quad #\hss\cr
A\tspace gitating\cr
B\tspace ewitching\cr
C\tspace onfounded\cr
D\tspace evilish affairs of life\tsh the most\cr
E\tspace xtravagant\cr
F\tspace utilitous\cr
G\tspace alligaskinish\cr
H\tspace andy-dandyish\cr
I\tspace racundulous (there is no K to it) and\cr
L\tspace yrical of all human passions: at\cr
\kern 30pt  the same time, the most\cr
M\tspace isgiving\cr
N\tspace innyhammering\cr
O\tspace bstipating\cr
P\tspace ragmatical\cr
S\tspace tridulous\cr
}}

\vskip -12pt
\noindent
\quad R\tspace idiculous\tsh though by the bye the\catch{R}
...
the one or the other.\patch{She}
...
garden which join’d and\catch{laid}
...
\dropcap{I}{t} is a great pity\tsh but
...
burnt like a beast\tsk\break I would oblige a housewife constantly to\catch{light}
...
know to this day where it lies.\patch{The}
...
which\catch{the} the expediency of my uncle Toby’s affairs had
...
she had\catch{got} got advanced to the door of the sentry-box, but to extend her right hand;
...
hand as soon as she possibly could;\catch{which,}
...
no sen-\catch{timent} timent\tsh it could neither give fire by pulsation \tsh or receive it by
...
Toby, in the simplicity of his soul, would lay his\catch{hand} hand flat
...
take up, or, with the gentlest pushings, protrusions, and equivocal compressions,\catch{that}
...
\dropcap{T}{hese} attacks of Mrs.\@ Wadman,
...
themselves, there is a plan of\catch{Bouchain}
...
\textit{stigmata} and\catch{\textit{pricks},}
...
\initial{I}{Think}, an’ please your
...
in returning out of Asia (when he sailed from\catch{Ægina}
...
happenest\catch{to} to be a story-teller, that of the number thou hast told me, either to amuse me in my
...
again\tsh provided it\catch{is} is not a merry one; to such,
...
conceptions, when a man is sitting squat upon the ground, to make\catch{a}
...
look of kindness with him, and set off thus.\etp\patch{The}
...
well got through the first five words\catch{of} of his story, had my uncle Toby twice
...
it, he put it on; and passing his hand across his fore-\catch{head} head to rub
...
Noah’s flood; and from Noah’s\catch{flood} flood to
...
Majority and Minority from tearing the very flesh off your bones\catch{in} in
...
\dropcap{I}{n} the year of our Lord one thousand seven hundred and twelve, there
...
which, from what thou hast dropt, I\catch{partly} 
...
such sweet encouragement did he\catch{utter} utter it, that the corporal went on
...
\dropcap{T}{here} was, an’ please your
...
passes very well without these niceties, unless one is pretty sure\catch{of}
...
mend\tsk himself to shave and keep clean, so as to appear al-\catch{ways} ways
...
name\tsk in what mountains it takes its\catch{rise} 
...
this\catch{part} part of his discourse\tsk how Marlborough could have
...
and Hochstet?\break\null\tsh Great as he was, corporal, he could\catch{not}
...
too inquisitive in knowing what great man\catch{was} was the discoverer, and what occasions
gave birth to it.
...
Alphonsus, who reduced Toledo, That\catch{in} in the year
...
hands\tsh my uncle Toby was so\catch{touch’d} touch’d with
...
\dropcap{T}{his} \textit{unfortunate} King of
...
to account for the\catch{epithet} epithet\tsh Was he \textit{unfortunate},
...
said my uncle Toby\tsh And I believe, con-\catch{tinued} tinued
...
which covered the re-\catch{treat} 
...
ven! cried my uncle Toby\tsk he deserves\catch{a} 
...
cor-\catch{poral,} poral, before I was exchanged, and put into a cart
...
as ma-\catch{ny} ny tendons and what-d’ye-call-’ems (for I know
...
\dropcap{T}{he} anguish of my knee, continued the
...
that with the loss of blood, and the\catch{want} want of care-taking of
...
cottage, with\catch{no} no one but the young woman, and the peasant and his
...
under a cambrick border, laid close to her forehead: she\catch{was} was one of
...
Toby\tsk we’ll\catch{ask} ask Mr.\@ Yorick about it

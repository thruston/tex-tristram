...
\addfontfeature{LetterSpace=12.0}\textsc{the}\rlap{\quad\smash{\includegraphics[width=72pt]{sterne.png}}}\cr
...
\setlength{\baselineskip}{14pt}  % 20*14 = 280 280/19 \simeq 14.7368 
\sloppy


\section{\lsss{CHAP}.\enspace I.}

\dropcap{N}{o}\tsh I think, I said, I would\break
...
\stick{give me leave\tsk and in another place\tsk}
\stick{(but where, I can’t recollect now) speak-}
\stick{ing of my book as a \textit{machine}, and lay-}
\stick{ing my pen and ruler down cross-wise}\catch{upon} 
...
\stick{jects which came in my way, either with}\catch{sable,}
\stick{sable, or with a sickly green; in dangers}
\stck{ye gilded my horizon with hope, and when}
\stick{\textscl{Death} himself knocked at my door\tsk ye}
...
But there is no \textit{living}, Eugenius, re-\break 
\stick{plied I, at this rate; for as this \textit{son of a}}
\textit{whore} has found out my lodgings\tsh
...
\stick{do for me, except thyself; and as thou}\catch{seest} 
...
\stick{said Eugenius\tsk then by heaven! I will}
...
\stick{at my heels\tsh I’ll scamper away to}
\stick{mount Vesuvius\tsh from thence to Jop-}
\stick{pa, and from Joppa to the world’s end,}
\stick{where, if he follows me, I pray God} 
he may break his neck\tsh\patch{\tsk He}

\tsk He runs more risk \textit{there}, said Euge-\break
nius, than thou.
...
\tsk But mine, indeed, is a particular\break case\tsh
...
Pray captain, quoth I, as I was going\break
\stick{down into the cabin, is a man never over-}
taken by \textit{Death} in this passage?
...
\stick{undone! un\tsh O! undone!  sir\tsk}
...
let us get ashore.\patch{\ls{CHAP}.}
...
\dropcap{\raise10pt\hbox{\normalsize\large\lqq}N}{ow} before I quit Calais,\,” a tra-\break 
...
\stick{has been wrote of these things, by all who}
\stick{have \textit{wrote and gallop’d}\tsk or who have} 
\stick{\textit{gallop’d and wrote}, which is a different}
\stick{way still; or who for more expedition}\catch{than}
\stick{than the rest, have \textit{wrote-galloping}, which} 
...
\stick{\tsk there is not a gallopper of us all who} 
...
\stick{than I do this moment of \textit{Grand Cairo};} 
\stick{for it was dusky in the evening when I} 
\stick{landed, and dark as pitch in the morning}
\stick{when I set out, and yet by merely know-}\catch{ing}
...
\stick{was \textit{once} no more than a small village be-}
...
\stick{distinct families in the \textit{basse ville}, or sub-}
\stick{urbs\tsh it must have grown up by little} 
and little, I suppose, to it's\sic\ present size.\patch{Though}
...
\stick{for as there are fourteen thousand inhabi-}
...
\stick{and as I was told near sixty feet high\tsk}\catch{had}
...
\stick{than the great \textit{Square}; tho’ I cannot say}
...
\stick{that the French in general have more}\catch{reason} 
\stick{reason on their side in calling them} 
\stick{\textit{Places} than \textit{Squares}, which, strictly speak-}
...
\stick{nothing at all curious in the \textit{Courgain};} 
...
\stick{neatly built and mostly of brick; ’tis}\catch{extremely}
...
\stick{ever taking notice of \textit{La Tour de Guet},}
...
\stick{which are the strongest in the world, and}\catch{which,} 
...
\stick{very remarkable that at the \textit{Tête de Gra}-}
\stick{\textit{velenes}, and where the town is naturally}
...
\stick{\tsk However, after all that is \textit{said} and \textit{done},} 
...
\stick{easy enterance\sic which it gave our ances-}
\stick{tors upon all occasions into France:} 
\stick{it was not without its inconveniences}\catch{also;} 
\setlength{\baselineskip}{14.74pt}% 20*14 = 280 280/19 \simeq 14.7368 
...
\stick{sery; the gallantry of \textit{Eustace de St.}}
\stick{\textit{Pierre}, who first offered himself a vic-}
...
\stick{injustice to the reader, not to give him a}\catch{minute} 
...
\stick{horses:\tsh for heaven’s sake, make}
\stick{haste\tsh ’Tis for high treason, quoth a}
\stick{very little man, whispering as low as}
\stick{he could to a very tall man that stood}
\stick{next him\tsh Or else for murder; quoth}
\stick{the tall man\tsh Well thrown size-ace!}
\stick{quoth I. No; quoth a third, the gen-} 
tleman has been committing\tsh\!\tsh.\patch{Ah!}
...
\stick{more gracious)\tsh No; it can’t be that,}
\stick{quoth a fourth\tsh (she made a curt’sy}
...
\stick{gentleman’s debts, quoth \textit{Ace}, for a} 
...
\stick{no debt but the debt of \textscl{Nature}, and I}
\stick{want but patience of her, and I will}
\stick{pay her every farthing I owe her\tsh}
\stick{How can you be so hard-hearted, \textscl{Ma}-}
\stick{\textscl{dam}, to arrest a poor traveller going} 
\stick{along without molestation to any one}\catch{upon} 
...
\tsh Now, in troth, ’tis a great pity,\break
...
\tsh So you have nothing \textit{else} in Bou-\break
logne worth seeing?\patch{\tsk By}

\topstrut\tsk By Jasus! there is the finest\break
\stck{\textscl{Seminary} for the
\textscl{Humanities}\tsh.\hfill}

\tsk There cannot be a finer; quoth I.

\section{\topstrut\lsss{CHAP}.\enspace VIII.}
...
\stick{of men or things in choler, \lqq\textit{the most}}
\stick{\textit{haste}, \textit{the worse speed},\,” was all the re-}\catch{flection} 
...
\textit{That something is always wrong in a}\break
\textit{French post-chaise upon first setting out}.

\noindent\stick{\indent Or the proposition may stand thus.}

\textit{A French postilion has always to alight}\catch{\textit{before}} 
\stick{\textit{before he has got three hundred yards out}}
\textit{of town}.

What’s wrong now?\tsh Diable!\tsh\break
\stick{a rope’s broke!\tsh a knot has slipt!}
\stick{\tsh a staple’s drawn!\tsh a bolt’s to} 
\stick{whittle!\tsh a tag, a rag, a jag, a}
...
\stick{go a foot ten thousand times\tsh or}
\stick{that I will be damn’d if ever I get into}
\stick{another\tsh but I take the matter coolly}
\stick{before me, and consider, that some tag, or}\catch{rag,}
...
\stick{ear to his left, and behind his sooty}\catch{muzzle}
\stick{muzzle discover’d such a pearly row} 
\stick{of teeth, that \textit{Sovereignty} would have}
...
\stick{in the map, than \textscl{Montreuil};\tsh I}
...
\stick{looking at her, she has let fall at least a}\catch{dozen} 
...
\stick{this creature a word about a \textit{statue’s}}
\textit{thumb!}\tsh

\tsk But as this sample is worth all\break
\stick{their thumbs\tsh besides I have her} 
\stick{thumbs and fingers in at the bargain if}
\stick{they can be any guide to me,\tsk and as} 
\stick{\textit{Janatone} withal (for that is her name)} 
\stick{stands so well for a drawing\tsh may}
...
\stick{not draw her in all her proportions, and}\catch{with} 
\setlength{\baselineskip}{14pt}% 20*14 = 280 280/19 \simeq 14.7368 
\stick{with as determin’d a pencil, as if I had}
her in the wettest drapery.\tsh

\noindent
\stck{\indent\tsk But your worships chuse rather that I}
...
\stick{answer for thee a moment; and\sic e’er}\catch{twice}
...
\stick{\tsk nay, thou mayest go off like a hussy}
\stick{\tsk and lose thyself.\tsk I would not answer}
...
\stick{haste as I have\tsk you had better stop:\tsk}\catch{\tsk She}
\stick{\tsk She has a little of the \textit{devote:} but}
...
\noindent
\stick{\lower-3pt\hbox{\ast}\ \textit{de Montreuil a Nampont} \crfill \hbox
to 56pt{\textit{poste et demi}\hfill}}\break
\stick{\textit{de Nampont} a Bernay          \crfill \hbox to 56pt{poste\hfill}}
...
\stick{de Nouvion a \textsc{Abbeville} \crfill \hbox to 56pt{poste\hfill}}

\noindent
\tsh but the carders and spinners were all\break gone to bed.
...
may pick out of the next chapter.\patch{\ls{CHAP}.}
...
\stick{of wiping my brows and smoothing my}\catch{pillow,} 
...
\stick{tual attention\tsh but mark.  This}
...
clatter in the house, shall wake the dead.\patch{\ls{CHAP}.}

\setlength{\baselineskip}{15.5556pt}% 20*14 = 280 280/19 \simeq 14.7368 280/18 \simeq 15.5556  
...
\stick{learned know, against the \textit{grand tour},} 
...
\stick{much unquietness; and so much of}\catch{rest,} 
...
Hollo! Ho!\tsh the whole world’s\break
\stick{asleep!\tsh bring out the horses\tsh}
\stick{grease the wheels\tsh tie on the mail\tsh} 
\stick{and drive a nail into that moulding\tsh} 
I’ll not lose a moment\tsh

Now the wheel we are talking of, and\break
\stick{\textit{whereinto} (but not \textit{whereonto}, for that} 
\stick{would make an Ixion’s wheel of it) he}
\stick{curseth his enemies, according to the}\catch{bishop’s}
...
\stick{\stick{their \lqq\small χωρισμὸν ἀπὸ τοῦ Σώματος, εἰς’ τὸ}}
\stick{\lqq {\small Καλῶς Φιλοσοφεῖν}\,”\tsh [their] \lqq \textit{getting}}
\stick{\lqq \textit{out of the body, in order to think}}
\stick{\lqq \textit{well}.\,” No man thinks right whilst} 
\stick{he is in it; blinded as he must be, with}
\stick{his congenial humours, and drawn dif-}\catch{ferently} 
\stick{ferently aside, as the bishop and my-}
\stick{self have been, with too lax or too} 
\stick{tense a fibre\tsh \textscl{Reason}, is half of it,} 
\stick{\textscl{Sense}; and the measure of heaven itself} 
\stick{is but the measure of our present appe-}
tites and concoctions\tsh

\tsh But which of the two, in the\break
\stick{present case, do you think to be mostly} 
in the wrong?

You, certainly: quoth she, to dis-\break
turb a whole family so early.\patch{\ls{CHAP}.}

\section{\chapstrut\lsss{CHAP}.\enspace XIV.}

\kern -0.33 \baselineskip

\quad\tsh But she did not know I was un-\break
\stick{der a vow not to shave my beard till I}
\stick{got to Paris;\tsh yet I hate to make}
\stick{mysteries of nothing;\tsh ’tis the cold}
\stick{cautiousness of one of those little souls}
\stick{from which \textit{Lessius} (\textit{lib}.\@ 13.\@ \textit{de moribus}}
\stick{\textit{divinis, cap.\@} 24.) hath made his esti-}
...
\stick{estimate\tsh unless from the parental} 
...
\stick{ber\tsh he certainly must have gone up-}
...
he wrote, almost to nothing.\patch{In}
...
\stick{other heathen god and goddess! for}\catch{now} 
...
and let me go on.\patch{\ls{CHAP}.}

\setlength{\baselineskip}{14pt}% 20*14 = 280 280/19 \simeq 14.7368 280/18 \simeq 15.5556  
\section{\chapstrut\lsss{CHAP}.\enspace XV.}

\quad\tsh \lqq So hating, I say, to make\break
\stick{mysteries of \textit{nothing}\,”\tsh I intrusted it} 
...
\stick{we danced it along to \textit{Ailly au clochers},} 
...
\stick{from Pequignay, I got to \textsc{Amiens},\qquad}\\[4pt]
...
\stick{numbers do in order to prevent it)\tsh} 
there is no help: and it is this.

That be you in never so kindly a pro-\break
\stick{pensity to sleep\tsh tho’ you are passing}\catch{perhaps} 
...
\stick{your eyes\tsk nay what is more, was you} 
...
\stick{as awake\tsh nay perhaps better\tsh}
\stick{Yet the incessant returns of paying for}
\stick{the horses at every stage,\tsh with the}
...
\stick{your soul from destruction.\hfill}\catch{\tsk I’ll}
...
\stick{\lqq a word.\,”\tsh Then there wants two}
\stick{sous more to drink\tsh or there is a}
...
\stick{self of these blows\tsk but then, by heaven!}\catch{you}
...
\stick{le Curè offers you a pinch of snuff\tsh}
\stick{or a poor soldier shews you his leg\tsh}
\stick{or a shaveling his box\tsh or the priest-}
\stick{esse of the cistern will water your wheels}
\stick{\tsh they do not want it\tsh but she}
\stick{swears by her \textit{priesthood} (throwing it} 
\stick{back) that they do:\tsh then you have}
...
\stick{as you can.\hfill}\catch{It}
...
\stick{means it was that I pass’d through St.}\catch{Dennis,} 
\stick{Dennis, without turning my head so} 
\stick{much as on one side towards the Ab-}
by\tsh
...
\stick{\textit{Jaidas’s lantern}\tsh nor for that either,}
\stick{only as it grows dark, it might be}
of use.\patch{\ls{CHAP}.}

\section{\chapstrut\lsss{CHAP}.\enspace XVII.}

\dropcap{C}{rack}, crack\tsh crack, crack\break
\tsh crack, crack\tsk so this is\break
\stick{Paris!  quoth I (continuing in the same} 
\stick{mood)\tsk and this is Paris!\tsh humph!}
\stick{\tsh Paris! cried I, repeating the name}
the third time\tsh
...
\stick{it smells\tsh crack, crack\tsh crack,}
\stick{crack\tsh What a fuss thou makest!\tsk}
\stick{as if it concern’d the good people to be}
\stick{inform’d, That a man with pale face,}\catch{and} 
\setlength{\baselineskip}{14pt}% 20*14 = 280 280/19 \simeq 14.7368 280/18 \simeq 15.5556  
...
\stick{\tsh but in the \textscl{School} of \textscl{Urbanity}}
...
sallad\tsk sallad and soup, \textit{encore}\tsh\patch{\tsh ’Tis}
...
\noindent
\stick{\indent One\tsk two\tsk three\tsk four\tsk five\tsk six\tsk}
\stick{seven\tsk eight\tsk nine\tsk ten.\tsk Ten cook’s}
\stick{shops! and twice the number of barbers!} 
\stick{and all within three minutes driving!}\catch{one}
...
Chief Magistrate in Toulouse, \&c. \&c. \&c.\par\egroup\patch{\ls{CHAP}.}
...
\stick{\lqq\textit{That they who have seen Paris, have seen}}
\stick{\textit{every thing},” they must mean to speak of} 
those who have seen it by day-light.\patch{As}
...
\stick{light are best to be \textit{seen}, \textit{felt}, \textit{heard and}}
\stick{\textit{understood} (which, by the bye is a quota-}
\stick{tion from Lilly)\tsh the devil a one of us}
\stick{out of fifty, can get our heads fairly thrust} 
in amongst them.\patch{This}
...
\stick{and that when you have seen them with}\catch{all} 
...
\stick{saded it moreover through all their parish}
\stick{churches, by no means omitting St.\@ \textit{Roche}}
...
\tsh but, ’tis what no one needeth to\break
\stick{tell you, for you will read of it yourself}
\stick{upon the portico of the Louvre, in these}
words,\\[3pt]
\fnast\ 
\textscl{Earth no such folks!\tsk no folks\bnq
\quad e’er such a town}\\
\textscl{As Paris is!\tsk Sing, derry, derry,\bnq
\quad down}.

\bgroup\footnotesize
\noindent\fnast\ Non Orbis gentem, non urbem gens habet ullam\bnq
\qquad\tsh\!\tsh\!\tsh\!\tsh\!\!\tsh ulla parem.
\par\egroup
\etp\rightline{The}
\newpage

The French have a \textit{gay} way of treat-\break
...
\stick{one (\textit{i}.\@ \textit{e}.\@ an author) in mind of the word}
\stick{\textit{spleen}\tsh especially if he has any thing} 
...
\stick{men\tsk not knowing how near they may}\catch{be}
...
\stick{sources and hidden springs which sustain}
...
quiries and reflections\tsh\patch{Still}
...
be at Fontainebleau before the king\tsh
...
\dropcap[findent=0pt]{N}{o\!w} \tight{I hate to hear a person, especially}\break
...
\stick{faster, \textit{consideratis}, \textit{considerandis}; there-} 
...
\stick{puny horses, with the very little they}\catch{give} 
...
\stick{ing in my fancy some time, but to no}\catch{purpose,} 
\stick{purpose, by what clean device or facete}
\stick{contrivance I might so modulate them,} 
\stick{that whilst I satisfy \textit{that ear} which the} 
\stick{reader chuses to \textit{lend} me\tsk I might not} 
...
\stick{worse consequence\tsh it will burn (I}
fear) my paper.

\tsh No;\tsh I dare not\tsh

But if you wish to know how the \textit{ab}-
\stick{\textit{bess} of Andoüillets, and a novice of her}
\stick{convent got over the difficulty (only first} 
\stick{wishing myself all imaginable success)\tsk} 
I’ll tell you without the least scruple.\patch{\ls{CHAP}.}

\section{\chapstrut\lsss{CHAP}.\enspace XXI.}

\dropcap{T}{he} abbess of Andoüillets, which\break
...
\stick{ing in danger of an \textit{Anchylosis} or stiff}
\stick{joint (the \textit{sinovia} of her knee becoming}
\stick{hard by long matins), and having tried}
\stick{every remedy\tsh first, prayers and}
\stick{thanksgiving; then invocations to all}
\stick{the saints in heaven promiscuously\tsh}
\stick{then particularly to every saint who had}
\stick{ever had a stiff leg before her\tsh then}
...
\stick{impotent from his youth\tsh then wrap-}\catch{ping}
...
\stick{animals\tsh then treating it with emol-}
\stick{lient and resolving fomentations\tsh}
...
\stick{chervil, sweet cecily and cochlearia\tsh}
\stick{and nothing all this while answering, was} 
...
\stick{got ready for her journey: a novice of}\catch{the} 
...
\stick{in sewing on the shreds of yellow bind-}\catch{ing,}
...
\stick{slowly to the calesh, both clad in white,}\catch{with} 
...
and wish I had been there.\patch{The}
...
\stick{little with the \textit{hows} and \textit{whens} of life;}
...
\stick{wine had leak’d out at the \textit{legal} vent of}
\stick{the borrachio, before one half of the}
journey was finish’d.\etp\patch{Man}
...
\stick{\hfill\lqq get}\par\vfill\eject\noindent
...
\stick{mours, \etc\etc and that if the wa-}\catch{ters} 
...
\stick{turn the obligation \textit{downwards} (as men} 
...
\stick{we do; let us leave him then in the vor-}\catch{tex} 
...
\tsh The old mule let a f\tsk\patch{\ls{CHAP}.}
...
\stick{novice, catching fire at the word \textit{servant}}\catch{\tsk why}
...
O my virginity! virginity! cried the\break abbess.
...
\stick{both\tsh but you may pronounce them}\catch{to} 
...
\stick{moment\tsh\hfill}
\stick{\hfill\tsh and}\etp\par\eject
...
\stick{\stick{betwixt yourself and another person\tsk in}}
course becomes diluted into no sin at
all.\patch{Now}

Now I see no sin in saying, \textit{bou}, \textit{bou},\break
\stick{\textit{bou}, \textit{bou}, \textit{bou}, a hundred times together;}
\stick{nor is there any turpitude in pronouncing}
\stick{the syllable \textit{ger}, \textit{ger}, \textit{ger}, \textit{ger}, \textit{ger}, were}
\stick{it from our matins to our vespers: There-}
\stick{fore, my dear daughter, continued the}
\stick{abbess of\sic Andouillets\tsk I will say \textit{bou},}
\stick{and thou shalt say \textit{ger}; and then alter-}
\stick{nately, as there is no more sin in \textit{fou} then\sic}
\stick{in \textit{bou}\tsk Thou shalt say \textit{fou}\tsk and I will} 
\stick{come in (like fa, sol, la, re, mi, ut, at}
\stick{our complines) with \textit{ter}. And accord-}
...
\textit{Abbess},\cr 
Margarita,\cr}}\;\Big\}\;
\vcenter{\halign{\hbox to 110pt{#}\cr
Bou\hfil -\hfil -\hfil bou\hfil -\hfil -\hfil bou\hfil -\hfil -\cr
\tsh\hfil ger,\hfil -\hfil -\hfil ger,\hfil -\hfil -\hfil ger\cr}}
$\\[4pt]
$
\vcenter{\halign{#\hss\cr
\textit{Margarita},\cr 
Abbess,\cr}}\;\Big\}\;
\vcenter{\halign{\hbox to 110pt{#}\cr
Fou\hfil -\hfil -\hfil fou\hfil -\hfil -\hfil fou\hfil -\hfil -\cr
\tsh\hfil ter,\hfil -\hfil -\hfil ter,\hfil -\hfil -\hfil ter.\cr}}
$
...
\stick{There’s \textscl{Fontainbleau}, and \textscl{Sens},}
\stick{and \textscl{Joigny}, and \textsc{Auxerre}, and \textsc{Dijon}}
\stick{the capital of Burgundy, and \textscl{Challon},} 
\stick{and Mâcon the capital of the Mâconese,}
\stick{and a score more upon the road to}
\stick{\textscl{Lyons}\tsh and now I have run them}
\stick{over\tsh I might as well talk to you of} 
\stick{so many market-towns in the moon, as} 
\stick{tell you one word about them: it will be}
\stick{this chapter at the least, if not both this}\catch{and}
...
\stick{as I never blot any thing out\tsh let us}\catch{use} 
...
hope, a little to go on.\patch{\ls{CHAP}.}

\section{\chapstrut\lsss{CHAP}.\enspace XXVII.}

\quad\tsh All you need say of \textit{Fontain}-
\stick{\textit{bleau} (in case you are ask’d) is, that it}
\stck{stands about forty miles (south \textit{something})}
\stick{from Paris, in the middle of a large}
\stick{forest\tsh That there is something great} 
\stick{in it\tsh That the king goes there once,}
...
As for \textscl{Sens}\tsh you may dispatch it\break 
in a word\tsh \lqq\textit{’Tis an archiepiscopal\break see}.”

\tsh For \textscl{Joigny}\tsk the less, I think,\break
one says of it, the better.

But for \textscl{Auxerre}\tsk I could go on for
\stick{ever: for in my \textit{grand tour} through Eu-}
...
\stick{the family, except my mother, who being}\catch{taken}
...
\stick{at home at \textscl{Shandy Hall}, to keep}
...
\stick{has left me enough to say upon \textscl{Aux}-}
\stick{\textscl{erre}: in short, wherever my father} 
...
\stick{kings and courts and silks of all colours,}\catch{in} 
...
\stick{which comes to the same point\tsk till the}\catch{world,}
\stick{world, finally, takes it into it’s\sic\ head to}
stand still.\tsh

\tsh But this rich bale is not to be\break
\stick{open’d now; except a small thread or} 
\stick{two of it, merely to unravel the mystery}
of my father’s stay at \textscl{Auxerre}.
...
\stick{\tsh I’ll go see any body; quoth my} 
\stick{uncle Toby; for he was all compliance}
\stick{thro’ every step of the journey\tsh De-}\catch{fend} 
...
\stick{ready for the purpose; he led us into the}\catch{tomb}
...
\stick{had when any thing hugely tickled}\catch{him;} 
...
\stick{tains the bones of Saint \textscl{Maxima}, who}
\stick{came from Ravenna on purpose to touch} 
the body\tsh

\tsh Of Saint \textscl{Maximus}, said my fa-\break
\stick{ther, popping in with his saint before him}
\stick{\tsk they were two of the greatest saints in}
\stick{the whole martyrology, added my father}\catch{\tsh Excuse} 
\stick{\tsh Excuse me, said the sacristan\tsh}
\stick{\tsh ’twas to touch the bones of Saint} 
\stick{Germain the builder of the abby\tsh} 
\stck{And what did she get by it? said my uncle}
\stick{Toby\tsh What does any woman get by}
\stick{it? said my father\tsh \textscl{Martyrdome};}
...
\stick{\tsh A desperate slow one, an’ please} 
\stick{your honour, said Trim, unless one could}
\stick{purchase\tsh I should rather sell out en-}\catch{tirely,} 
\stick{tirely, quoth my uncle Toby\tsh I am} 
\stick{pretty much of your opinion, brother} 
Toby, said my father.

\tsh Poor St.\@ Maxima! said my\break
...
\stick{\tsh But who the duce has got lain down}
\stick{here, besides her, quoth my father, point-}
\stick{ing with his cane to a large tomb as we}
\stick{walked on\tsh It is Saint \textit{Optat}, Sir, an-}
\stick{swered the sacristan\tsh And properly is}
\stick{Saint Optat plac’d!\@ said my father: And}
\stick{what is Saint Optat’s story? continued} 
\stick{he. Saint \textit{Optat}, replied the sacristan,}
was a bishop\tsh\patch{\tsh I}

\tsh I thought so, by heaven! cried\break
\stick{my father, interrupting him\tsk Saint}
\stick{Optat!\tsh how should Saint \textit{Optat} fail?}
\stick{so snatching out his pocket-book, and the}
...
\stick{found a treasure in Saint Optat’s tomb,} 
...
\stk{over the square\tsk And while you are paying}\catch{that}
...
\stick{help’d me through \textit{Auxerre}, I have been}
...
\stick{brought myself into such a situation, as}\catch{no}
...
\bgroup\footnotesize
\indent\fnast\ The same Don Pringello, the celebrated Spa-\break
nish architect, of whom my cousin Antony has\break
...
\stick{livres\tsh and from thence, continued~I,}
...
\stick{thing\tsh I shall gain four hundred livres} 
\stick{by the misfortune clear into my purse;}\catch{and}
...
\stick{with the \textscl{Vivares} on my right-hand, and} 
\stick{\textscl{Dauphiny} on my left, scarce seeing the} 
\stick{ancient cities of \textscl{Vienne}, \textit{Valence}, and}
\stick{Vivieres. What a flame will it rekindle}
\stick{in the lamp, to snatch a blushing grape}
\stick{from the Hermitage and Cotê roti, as I} 
...
\stick{\stick{Would Monsieur chuse to sell it? rejoin’d}}
...
leather you may take to live on.\etp\patch{What}
...
\stick{my hand, reflecting upon what had \textit{not}}
...
\tsh I’ll go into Wales for six weeks,\break
\stick{and drink goat’s whey\tsk and I’ll gain}
...
\stick{call’d her, with so many small evils: sure-}
...
pension to me.\patch{\tsh One}

\tsh One of a hundred a year, or so,\break
...
\textscl{Vexations}, as knowing what\break
...
\stick{to see it. To be withheld upon \textit{any} ac-}
\stick{count, must be a vexation; but to be}
\stick{witheld \textit{by} a vexation\tsh must certainly}
...
\stick{the milk and coffee together\tsk other-}
...
\stick{\hss every}\par\vfill\eject\noindent
...
\stick{list\tsh I leave to the curious as a pro-}
...
\stick{who stood behind me\tsh ’twill be no}
\stick{hurt if \textsc{we} go to the church of St.\@ Ire-}
\stick{neus, and see the pillar to which Christ}
\stick{was tied\tsh and after that, the house}
\stick{where Pontius Pilate lived\tsh ’Twas at}
\stick{\hss the}\par\vfill\eject\noindent
\stick{the next town, said the \textit{valet de place}\tsk} 
...
\stick{\lqq the sooner shall I be at the \textit{Tomb of the}}
...
well for the reader if I explain it myself.\patch{\ls{CHAP}.}

\section{\chapstrut\lsss{CHAP}.\enspace XXXI.}
...
\noindent
\stick{Amandus taken captive by the Turks,}
\stick{and carried to the emperor of Mo-}
\stick{rocco’s court, where the princess of Mo-}
\stick{rocco falling in love with him, keeps him}\catch{twenty}
...
\noindent
\stick{at every town and city sitting down for-}
...
\stick{they fly into each others arms, and both}
drop down dead for joy.

There is a soft æra in every gentle\break
\stick{mortal’s life, where such a story affords} 
\stick{more \textit{pabulum} to the brain, than all the} 
\stick{\textit{Frusts}, and \textit{Crusts}, and \textit{Rusts} of antiquity,} 
...
\stick{much as see even a \textit{Lyons-waistcoat}, but} 
\stick{this remnant of antiquity would present}
\stick{itself to my fancy; and I have often said}
\stick{in my wild way of running on\tsk tho’} 
\stick{I fear with some irreverence\tsk \lqq I}
...
pay it a visit.\sic\patch{In}

In my list, therefore, of \textit{Videnda} at\break 
\stick{Lyons, this, tho’ \textit{last},\tsk was not, you see,} 
\stick{\textit{least}; so taking a dozen or two of longer}
\stick{strides than usual across my room, just} 
\stick{whilst it passed my brain, I walked down} 
\stick{calmly into the \textit{Basse Cour}, in order to} 
...
when I was stopped at the gate\tsh\patch{\ls{CHAP}.}
...
\stick{him: on the contrary, meet him where I}\catch{will}
...
\stick{this: for parrots, jackdaws, \etc\@\tsh I} 
\stick{never exchange a word with them\tsh} 
\stick{nor with the apes, \etc for pretty near}
\stick{the same reason; they act by rote, as the}\catch{others} 
...
\stick{beyond the \textit{proposition}, the \textit{reply}, and \textit{re}-}
\stick{\textit{joinder}, which terminated my father’s and}
\stick{my mother’s conversations, in his beds} 
\stick{of justice \tsh and those utter’d\tsh there’s}
an end of the dialogue\tsh

\tsh But with an ass, I can commune\break
for ever.
...
\tsh He turned his head thoughtful\break
\stick{about, and looked witfully the opposite}
way\tsh

\noindent
\stick{\indent\tight{I understand thee perfectly; answered I}}\break
\stick{\tsh if thou takest a wrong step in this}
\stick{affair, he will cudgel thee to death\tsh}
...
\stick{the little peevish contentions of nature}\catch{betwixt} 
\stick{betwixt hunger and unsavouriness, had}
\stick{dropt it out of his mouth half a dozen}
\stick{times, and pick’d it up again\tsh God}
...
\stick{\tsh And now thy mouth, if one knew} 
...
\stick{roon.\tsh In saying this, I pull’d out a} 
...
\stick{santry in the conceit, of seeing \textit{how} an} 
\stick{ass would eat a macaroon\tsh than of be-}\catch{nevolence}
...
\stick{beast was heavy loaded\tsh his legs seem’d}
...
which put an end to the ceremony.\\[6pt]
...
me for that purpose.\patch{\ls{CHAP}.}

\section{\chapstrut\lsss{CHAP}.\enspace XXXIV.}

\dropcap{W}{hen} all was set to rights, I\rlap{\quad\smash{\raise25pt\hbox{\club}}}\break
came down stairs again into the\break
\stick{\textit{basse cour} with my valet de place, in order}
\stick{to sally out towards the tomb of the two}
\stick{lovers, \etc\tsk and was a second time}
...
\stick{upon the part of the king, replied the}\catch{commissary,} 
...
\textit{Pardonnez moi}\tsk replied the commis-\break
\stick{sary, you are indebted to him six livres}\catch{four}
...
\stick{racter of these people! quoth I\tsk (aside)}\catch{they}
\stick{they understand no more of \textscl{irony} than}
this\tsh
...
\etp\rightline{And}\eject\etp
% \setlength{\baselineskip}{13.3333pt}% 20*14 = 280 280/19 \simeq 14.7368 280/18 \simeq 15.5556  280/21 \simeq 13.3333 
...
I go by \textscl{water}\tsk said I\tsk and here’s
...
\tsh ’Tis contrary to the \textscl{gospel}.
...
\tsh By all which it appears, quoth I,\break 
...
\stick{all the days of his life\tsk or pay for it.\tsk}
...
\stick{nued he, upon this, that the \textscl{revenues}}\catch{are}
\stick{are not to fall short through your \textit{fickle}-}
\textit{ness}\tsh
...
with you we can\tsh\\[4pt]
\stick{\hss\textsc{and so the peace was made};\hss}

\tsh And if it is a bad one\tsk as Tris-\break
...
\stick{imposition amongst my remarks before I}\catch{retir’d}
...
\stick{care of \textit{their} remarks for the future) \lqq my}
\stick{\lqq remarks were \textit{stolen}\,”\tsh Never did}
...
\stick{I should\tsh My remarks are stolen!\tsk} 
\stick{what shall I do?\tsk Mr.\@ commissary!}
\stick{pray did I drop any remarks as I stood} 
besides you?\tsh

You dropp’d a good many very singu-\break
\stick{lar ones; replied he\tsh Pugh! said I,}
\stick{those were but a few, not worth above} 
\stick{six livres two sous\tsk but these are a large}\catch{parcel} 
...
\textscl{furniture}, did not exclaim more bitterly.
...
\stick{confusion into which this jumble of cross}\catch{accidents} 
...
\stick{vamper. \hskip 78pt  I leave this} 
\stick{\stick{void space that the reader may swear in-}}
\stick{to it, any oath that he is most accustomed}
\stick{to\tsh For my own part, if ever I swore}
\stick{a \textit{whole} oath into a vacancy in my life, I} 
...
\stick{egg is worth a penny\tsk Have I been selling}
...
\stick{been to Dodsley, or Becket, or any cre-}\catch{ditable} 
...
\section{\chapstrut\lsss{CHAP}.\enspace XXXIX.}
...
went to the May-poles\tsh\etp

The French women, by the bye, love\break
\stick{May-poles, \textit{a la folie}\tsk that is, as much as}\catch{their}
...
\stick{off her hair\tsh the toilet stands still for}
\stick{no man\tsh so she jerk’d off her cap, to}
\stick{begin with them as she open’d the door,}
\stick{in doing which, one of them fell upon the}\catch{ground} 
...
\stick{\tsh \textit{J’en suis bien mortifiée}, said she\tsh} 
...
They will be worse twisted still.\patch{\ls{CHAP}.}
...
\stick{said François\tsh for ’tis almost eleven}
...
\stick{for some years\tsh It will give me the} 
\stick{more time, thought I, to peruse the Chi-}
\stick{nese history; and besides I shall be able} 
\stick{to give the world a better account of the}\catch{clock} 
...
\stick{gratified\tsh The truth was, my time} 
\stick{was short, and my heart was at the Tomb}
\stick{of the Lovers\tsh I wish to God, said I,}
\stick{as I got the rapper in my hand, that the}
\stick{key of the library may be but lost; it fell}
out as well\tsh\patch{For}

\textit{For all the} \textscl{Jesuits} \textit{had got the cholic}\break
\stick{\tsk and to that degree, as never was known} 
...
Tomb of the Lovers, as well as\break\etp
...
\stick{manda\tsk long\tsk long have I tarried to} 
\stick{drop this tear upon your tomb\tsh I}
come\tsh I come\tsh\etp

When I came\tsk there was no tomb to\break drop it upon.
...
\stick{lovers\tsk or rather I did not fly \textit{from} it\tsk}
...
\stick{Avignon,\tsh Though you’d have seen} 
...
\stick{have taken it, in dudgeon; for my own}\catch{part,} 
...
\stick{nion\sic,\tsh that he should therefore say,}
...
\stick{country about as a proverb\tsh I set it} 
\stick{down, merely to ask the learned what can}\catch{be}
...
\tsk \textit{But Monsieur le Marquis} had\break
walked in\tsh\patch{\ls{CHAP}.}

\section{\chapstrut\lsss{CHAP}.\enspace XLIII.}

\initial{I}{Had} now the whole south of France,\break
from the banks of the Rhône to those\break
\stick{of the Garonne to traverse upon my} 
\stck{mule at my own leisure\tsk \textit{at my own leisure}}
\stick{\tsh for I had left Death, the Lord knows}
\stick{\tsh and He only\tsk how far behind me}
\stick{\tsh \lqq I have followed many a man thro’}
\stick{France, quoth he\tsk but never at this}
\stick{mettlesome rate.\,”\tsh Still he follow-}
\stick{ed,\tsh and still I fled him\tsh but I fled} 
\stick{him chearfully\tsh still he pursued\tsh but,} 
...
\noindent
\stick{\indent\tight{So notwithstanding all the commissary}}
\stick{of the post-office had said, I changed the}\catch{\textit{mode}}
\stick{\textit{mode} of my travelling once more; and,}
...
\stick{on their hands, which they know not}\catch{what}
...
\tsh This is most terrible work; judge\break
...
\tight{I had three several times loiter’d \textit{terribly}}\break
...
\stick{fairs of \textit{Baucaira} and \textit{Tarascone}\tsk I did} 
not understand the principles\tsh\patch{The}
...
across this plain\tsk and which, therefore, I call my

\vfill

\centerline{\textscl{Plain Stories}.}
...
\stick{the gun as to time\tsk by stopping and}
...
\stick{gars, pilgrims, fiddlers, fryars\tsk not} 
\stick{passing by a woman in a mulberry-tree}\catch{without} 
\stck{without commending her legs, and tempt-} 
\stick{ing her into conversation with a pinch of}
\stick{snuff\tsh In short, by seizing every}
\stick{handle, of what size or shape soever,}
\stick{which chance held out to me in this jour-} 
\stick{ney\tsk I turned my \textit{plain} into a \textit{city}\tsk I was} 
...
\stick{beneath it, it looks so like the simplicity}\catch{which}
...
\stick{belongs to the honest canons of \textscl{Mont}-}
\stick{\textscl{pellier}\tsk and foul befall the man who} 
...
\stick{made a dead point\tsh ’Tis the fife and}
\stick{tabourin, said I\tsh I’m frighten’d to}
\stick{death, quoth he\tsh They are running at}
\stick{the ring of pleasure, said I, giving him}
\stick{a prick\tsh By saint Boogar, and all the}
\stick{saints at the backside of the door of pur-}\catch{gatory,} 
\stick{gatory, said he\tsk (making the same reso-}
\stick{lution with the abbesse of Andoüillets)} 
\stick{I’ll not go a step further\tsh ’Tis very}
...
\stick{out both her hands, as if to offer them\tsk}\catch{And} 
...
\stick{sat upon the bank\tsh Tie me up this} 
\stick{tress instantly, said Nannette, putting a} 
\stick{piece of string into my hand\tsk It taught}\catch{me}
...
\centerline{\hbox to 80pt{\textscl{Viva la joia}!\hss}}
\centerline{\hbox to 80pt{\textscl{Fidon la tristessa}!\hss}}
...
\stick{a sous\tsk \textit{Viva la joia!} was in her lips\tsk}
\stick{\textit{Viva la joia!} was in her eyes. A tran-}\catch{sient}
...
\stick{lines, that I might go on straight for-}\catch{wards,}

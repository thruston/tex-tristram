...
\dropcap{W}{hen} my father had danced his white bear backwards and forwards through
...
\textit{Stevinus})\tsk He was so;\catch{bro-}
...
\textit{nah},\tsk which is more than you can say:\catch{\tsh Is}
...
\dropcap[findent=0pt]{D}{octor} \textit{Slop} and
...
the small twigs inwards.\tsh There are a\catch{thou-} thousand unnoticed openings,
...
\dropcap{I}{t} was some time in the summer of
...
said my\catch{uncle\enspace} uncle \textit{Toby},\tsk do \textit{Trim},\tsk and ask if
he knows his name.
...
\dropcap{I}{t} was not till my uncle \textit{Toby} had knocked the
...
honour, that he had no servant\catch{with} 
...
\stick{not have said that, \textit{Trim}, said my uncle} 
\stick{\textit{Toby},\tsk for God only knows who is a hy-}
...
the world to turn themselves\tsk That\break\stick{\tighter{notwithstanding my
...
\stck{thoughts towards the private distresses at}\break
...
\dropcap{\Tsk M}{y} uncle \textit{Toby}
...
\dropcap{T}{he} sun looked bright the morning
...
\initial{I}{Am} so impatient to return to my own
...
which I suppose a \stick{general one with those of his
profession,} on the
...
\tsk for I have stolen the greatest part of it. Doctor}
Paidagunes \textit{found me out.\hfill \fist  Set\break a 
thief to catch a thief.\tsh}
...
\stck{selves,\tsk one may safely suppose he meant}\break pretty near the same thing.
...
more 
\stck{entertaining than those tied up with them;}\break
\tsk for
...
puzzled still upon finding \textit{a l’octava alta!}
...
very distinct ideas of their several cha-\catch{racters} racters upon his fancy,\tsk whatever
...
general review, which to this day smells horribly of\break
horse-drugs.\tsh Whether these marks\break of humiliation were
...
excepting in this one instance, upon the first leaf of his\catch{sermon,}
...
\dropcap{W}{hen} my uncle \textit{Toby} had turned
...
\dropcap{M}{y} uncle \textit{Toby} had scarce
...
\dropcap{M}{y} uncle \textit{Toby} took the ivory
...
\stick{\textit{Toby}, a singleness of heart which misled}
...
\stick{\textit{Toby} a surfeit of sieges; and though he}
...
\stick{always console my uncle \textit{Toby} upon these}\break
...
\stick{when I hear it, \textit{Trim}, said my uncle}
\stick{\textit{Toby};\tsk for they don’t want personal bra-}

...
\noindent
Page 33.\@ Vol.\@ VII.\@ last line, dele \i{and}.\\[2pt]
Page 71.\@ Vol.\@ VII.\@ 3d line instead of striking\\[2pt]
\null\quad read \i{sticking}\\[2pt]
Page 34.\@ Vol.\@ VIII.\@ 13th line, read \i{inflam}-\\[2pt]
\null\quad \i{matory}.
...
\addfontfeature{LetterSpace=12.0}\s{the}\rlap{\quad\smash{\includegraphics[width=72pt]{sterne.png}}}\cr
...
\tsk He runs more risk \i{there}, said Euge-\break
nius, than thou.
...
\dropcap{C}{alais}, \i{Calatium, Calusium,\break
Calesium.}
...
\dropcap[findent=1pt]{\hbox to 24pt{\Tsk}B}{\lsss{oulogne}}!\tsk hah!\break
...
\stick{tleman has been committing\tsh\!\tsh.}\patch{Ah!}
...
\tsh So you have nothing \i{else} in Bou-\break
...
\noindent
\stick{\raise3pt\hbox{\ast}\ \i{de Montreuil a Nampont} \crfill \hbox
to 56pt{\i{poste et demi}\hfill}}\break
\stick{\i{de Nampont} a Bernay          \crfill \hbox to 56pt{poste\hfill}}

\bgroup\footnotesize
\noindent\quad\raise2pt\hbox{\ast}\ Vid.\@ Book of French post-roads, page 36.\break
edition of 1762.
\par\egroup
\rightline{de}
\eject
...
\dropcap{\raise10pt\hbox{\large“}\i{M}}{\i{ake}} 
...
\stick{their \lqq\smaller χωρισμὸν ἀπὸ τοῦ Σώματος, εἰς’ τὸ}
\stick{\lqq {\smaller Καλῶς Φιλοσοφεῖν}\,”\tsh [their] \lqq \i{getting}}
...
\stick{tense a fibre\tsh \s{Reason}, is half of it,} 
...
\setlength{\baselineskip}{14.7368pt}% 20*14 = 280 280/19 \simeq 14.7368 
...
sallad\tsk sallad and soup, \i{encore}\tsh\patch{\tsh ’Tis}
...
\stick{\i{gourmands}\tsh we shall rank high; if}
...
words,\\[3pt]
\fnast\ 
\s{Earth no such folks!\tsk no folks\bnq
\quad e’er such a town}\\
\s{As Paris is!\tsk Sing, derry, derry,\bnq
\quad down}.
...
\centerline{$\vcenter{\offinterlineskip\halign{\tstrut 10pt\small #\hss\cr
\i{Abbess},\cr 
\i{Margarita},\cr}}\Big\}$
\hss
$\vcenter{\offinterlineskip\halign{\hbox to 119pt{\tstrut 10pt\small #}\cr
...
\stick{\indent Quicker still\tsk God preserve me! said}
\stick{the abbess\tsk They do not understand us,}
\stick{cried Margarita\tsh But the Devil does,}
...
in a word\tsh \lqq\i{’Tis an archiepiscopal\break see}.”
...
\stick{\tsk ’twas to touch the bones of Saint} 
\stick{Germain the builder of the abby\tsk} 
...
\stick{\tsk But who the duce has got lain down}
...
leather you may take to live on.\patch{What}
...
\catch{\tsh any}
\stick{\tsk any other man would have sunk}
down to the center\tsh

\tsh Every thing is good for some-\break
thing, quoth I.
...
\parskip12pt plus 2pt minus 2pt

\chap{XXXII}{24pt}{8pt}

\dropcap{\hbox to 24pt{\Tsk}\raise10pt\hbox{\large’}T}{was} by a poor ass who had\break
...
ther he was to go in, or no.\etp
...
\stick{\kern 36pt \i{Out upon it!}\hss}
\vfill
\rightline{cried}
\eject
\noindent
...
\i{Out upon it!} in my opinion, should have come in here\tsh but this I leave
to be settled by\\[4pt]
\stick{\hfill\hbox{\vbox{\halign{\hss # \hss\cr
The\cr
\textsc{\addfontfeature{LetterSpace=32}reviewers}\cr
of\cr
\textsc{\addfontfeature{LetterSpace=32}my \ breeches}.\cr
}}}\hfill}\break
\stick{which I have brought over along with}
me for that purpose.
\patch{\ls{CHAP}.}
\parskip 8pt plus 2pt

\chap{XXXIV\sic}{32pt}{10pt}

\dropcap{W}{hen} all was set to rights, I\break%\rlap{\quad\smash{\raise25pt\hbox{\club}}}\break
...
\stick{lovers, \et\hbox{\itshape c.}\tsk and was a second time}
...
As it is\tsh\\
\tsh ’Tis contrary to the \i{law of nature}.\\
\tsh ’Tis contrary to \i{reason}.\\
\tsh ’Tis contrary to the \s{gospel}.

But not to this\tsh said he\tsk putting a\break\etp
...
\tsh By all which it appears, quoth I,\break\etp
...
with you we can\tsh\\[2pt]
\stick{\hss\s{and so the peace was made};\hss}
...
\stick{\lqq remarks were \i{stolen}\,”\tsh Never did}
...
striding it away to the cathedral.\etp
...
the Rhône, before I made it\tsh\etp
...
arming himself at all points against them.\etp
...
\stick{out both her hands, as if to offer them\tsk}
\catch{And} 
\parskip 6pt

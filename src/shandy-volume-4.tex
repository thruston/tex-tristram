...
\stick{\itshape peregrinus, donec pervenio, ad\tsk Quem lo-}
...
\stick{\textit{have expected from him}) that there is many}
...
\stick{many strange things, with equal confid-}
\stick{\tight{ence on all sides, and with equal eloquence}}
...
\stck{paragons of beauty--the finest made man!}
...
and expansion imaginable\tsk In the tri-
umph of which

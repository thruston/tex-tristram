...
any kind or degree,\catch{to} to be got at, let the case have been never so urgent, within
...
nicety of temper, because he thought it did honour to him.\\\catch{But}
...
\stick{verty, and sickness, and affliction dwelt}\break together.\\\catch{For}
...
to make a fire to offer it up with.}\\\catch{\textit{Yorick}}
...
then he fell, as many a worthy man had fallen before him.\\\catch{\textit{Yorick},}
...
is wanted, we can no way do without her.\\\catch{I}
...
face, as if the destinies had actually spun me without one.\\\catch{How}
...
other of them all the way.\\\catch{From}
...
downright earnest.\\\catch{Whether}
...
him and my father will go on as well again.\\\catch{\tsk Pray}
...
and for ever hereafter be treated of in the same chapter.\\\catch{As}
...
that which I have pitch’d\break upon.\\\catch{A}
...
character of the other.\\\catch{Now}

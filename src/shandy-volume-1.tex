...
he chearfully paid the fees for the ordinaries licence himself, amounting, in the
...
\stick{ble in combing of asses tails, and plucking}
...
What the loss in such a balance might \tight{amount to, \textit{communibus
...
\stick{that ’tis so bruised and mis-shapen’d with}
...
\stick{so inattentive in reading the last chapter?}
...
\noindent
\stick{\quad\tight{As for the \textit{Argumentum Tripodium},
which}}
is never used but
...
\dropcap{I}{f} I was not morally sure that the
...
\dropcap{T}{he} wound in my uncle
...
\bigskip
\centerline{\lsss{\itshape END} of the \textsc{First Volume}.}
\end{document}

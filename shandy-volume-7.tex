...
\lettrine{N}{\,\ls{\,o}}\tsh I think, I said, I
...
\lettrine{N}{\,\ls{ow}} hang it! quoth I, as I look’d towards the French coast\tsk a man should
...
hey-day! the cells are broke \stick{loose one into another, and the blood, and} the lymph,
...
\stick{\tsk hollo! cabin boy! what’s the matter?\tsk\hfill}
...
\lettrine{I}{\,\ls{t}} is a great inconvenience to a man in a haste, that there are three
...
\lettrine{\lower-10pt\hbox{\normalsize\large\lqq}N}{\,\ls{ow}} before I quit
...
\lettrine{C}{\,\ls{alais}}, \textit{Calatium, Calusium,\\
Calesium.}
...
suppose, to it's present size.\patch{Though}
...
\stick{’tis either well paved or well built; but ’tis}\break in the heart of the town, and most of the streets,
...
\lettrine{\hbox to 42pt{\Tsk B}}{\ls{oulogne}}!\hbox to 75pt {\tsk hah!}\break
...
quoth I. No; quoth a third, the gen-\break tleman has been committing\tsh\tsh.\patch{Ah}
...
molestation to any one\catch{upon} upon his lawful occasions? do stop that
...
\lettrine{W}{\,\ls{hen}} the precipitancy of a
...
\lettrine{T}{\,\ls{here}} is not a town in all France which, in my opinion, looks better in the
...
the days of my life,\tsk if I do not draw her in all her proportions, and\catch{with} with as
...
\stick{worships and reverences, may all measure}\break
...
life, I would not\break answer for thee a moment; and e’er\catch{twice}
...
\lettrine{A}{\!\ls{ll}} which being considered, and\break
...
\eject
\noindent
\stick{de Bernay a Nouvon              \crfill \hbox to 50pt{poste\hfill}}
...
\lettrine{W}{\,\ls{hat}} a vast advantage is travelling!
...
\lettrine{W}{\,\ls{as}} I in a condition to stipulate with
...
\lettrine{\lower-10pt\hbox{\large“}\textit{M}}{\,\itshape\ls{ake}} 
...
\stick{which David prophetically foresaw would}\break haunt the
...
damn’d to the end of the world.\patch{From}
...
\lettrine{I}{\,\ls{n}} the whole catalogue of those
...
\lettrine{C}{\,\ls{rack}}, crack\tsh crack, crack\break\tsh crack, crack\tsk so this is Paris!  quoth I
...
\lettrine{T}{\,\ls{he}} French are certainly misunderstood:\tsh but whether the fault is theirs,
...
\stick{amongst words, as politicians do amongst}\break
...
supper, and brought\catch{on} on a bilious diarrhœa, which has brought me back again to my
...
\stick{commerce\tsk their finances, with all the re-}\break
...
\lettrine{N}{\,\ls{ow} }\tight{I hate to hear a person, especially}\break
...
\lettrine{T}{\,\ls{he}} abbess of Andoüillets, which if you look into the large set of
...
Lystra, who had been impotent from his youth\tsh then wrap-\catch{ping} ping it up in
...
novice of\catch{the} the convent of about seventeen, who had been troubled with a whitloe in
...
other in sewing on the shreds of yellow bind-\catch{ing,} ing, which the teeth of
...
half of the journey was finish’d.\patch{Man}
...
\lettrine{W}{\,\ls{e}} are ruin’d and undone, my\break
...
\lettrine{A}{\,\ls{ll}} sins whatever, quoth the abbess,
...
\lettrine{W}{\,\ls{hat}} a tract of country have I
...
\textit{Optat}, replied the sacristan, was a bishop\tsh\patch{\tsh I}

\tsh I thought so, by heaven! cried my father, interrupting
him\tsk Saint Optat!\tsh how should Saint \textit{Optat}
fail?\break
...
\stick{\tight{over the square\tsk And while you are paying}}\catch{that}
...
\lettrine{\hbox to 42pt{\hskip-.1em\Tsk N}}{\,\ls{ow}} this is the most puzzled\break
...
am this moment walking
across the market-place of Auxerre with my father and my uncle
Toby, in our way back to dinner\tsh and I am this moment also
entering Lyons with my post-chaise broke into a thousand
pieces\tsk and I am moreover this moment in a handsome pavillion
built by Pringello \fnast, upon the banks of the
...
\lettrine{T}{\,\ls{o}} those who call vexations,\break
...
\noindent
\stick{\indent\tight{When these curiosities are seen, quoth I,}}\break
...
\lettrine{O}{! there} is a sweet æra in the life of man, when (the brain being tender
and fibrillous, and more like pap than any thing else)\tsh a story read of two fond
lovers, separated from each other by cruel parents, and by still more cruel destiny
\tsh
...
$\left.\vcenter{\halign{#\hss\cr
Is Amandus\cr
Is my Amanda\cr}}\right\}$ still alive?\\[6pt]
...
lovers call’d upon them to\catch{attest} attest their truths\tsk I never could get into a scrape
...
\lettrine{\hbox to 24pt{\Tsk}\lower-10pt\hbox{\large’}T}{\,\ls{was}} by a poor ass who had\break
...
ceremony.\\[6pt]
\stick{\hss\textit{Out upon it!}\hss}
\vfill
\rightline{cried}
\eject
\noindent
...
\lettrine{W}{\,\ls{hen}} all was set to rights, I came
...
\stick{that if a man sets out in a post-chaise from}
...
founded, continued he, upon this, that the \textsc{revenues}\catch{are} are
...
\lettrine{T}{\,\ls{hough}} I was sensible I had said as
...
remarks before I\catch{retir’d} retir’d from the place; so putting my hand into my
...
\lettrine{W}{\,\ls{hen}} the first transport was over,
...
cre-\catch{ditable} ditable bookseller, who was either leaving off business, and
...
\lettrine{W}{\,\ls{hen}} we arrived at the
...
\lettrine{A}{\,\ls{nd}} now for Lippius’s
...
\lettrine{N}{\,\ls{o}} matter how, or in what
...
\lettrine{I}{\,\ls{ had}} now the whole south of
France, from the banks of the Rhône to those of
the Garonne, to traverse upon my \stick{mule at my own
...
\lettrine{I}{\,\ls{ had}} not gone above two leagues and
...
\stick{those which have arose out of the journey}\catch{across} across this plain\tsk and which, therefore, I call
my
...
\stick{sew’d up\tsk Nannette would not have given}\break
...
out a paper of black lines, that I might go on straight for-\catch{wards,}

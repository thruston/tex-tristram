...
\stick{tion, “ That I should neither think,} 
...
\newpage
\noindent
\stick{\hfill \tsh It would so; said my uncle Toby.}
Why then, an’
...
\stick{knows!\tsh but be it where it will,}\pb 
...
\stick{as, “ With what skins\tsh and if they}
...
\stick{door, he turn’d about \tsh “ Let us}
...
\lettrine{\Tsk {\normalsize\lower -11pt \hbox{“}\ }N}{\,\lss{ow}}\nobreak
...
\noindent
\stick{\hfill Now in all common and ordinary cases,}
...
\stick{but a sad signature of “ How our plea-}
\stick{“ sures slip from under us in this world ;”\hfill}
...
\newpage
“\textit{L—d! I cannot look at it\tsh}\\
\stick{“ \textit{What would the world say if I look’d}}
\stick{\qquad“ \textit{at it?}\hfill}
\stick{“ \textit{I should drop down, if I look’d at it}\tsk}
\stick{“ \textit{I wish I could look at it}\tsh\hfill}
\stick{“ \textit{There can be no sin in looking at it}.\hfill}
\stick{\quad\tsh “ \textit{I will look at it}.”\hfill}
...
prithee,\pb step directly for it, Trim, said my uncle Toby, and bring it into the
parlour.
...
This requires a second translation\thinspace :\tsk\break it shews what little
...
\noindent
\stick{\hfill The imagery under which \textit{Slawkenber-}}
\stick{\textit{gius} impresses this upon his reader’s fancy,}\pb
...
\noindent
\stick{\indent “ I have nothing, good Lady, but}
\stick{“ empty bottles;” says the asse.\hfill}
...
\noindent
\stick{\hfill I am determined, answered \textit{Slawkenber-}}
...
\stick{to do, than make love to her\tsh “ \textit{And}}
\stick{“ \textit{I’ll let him as much as he will},” said}
...
\stick{\tight{hopes, as she is sensible for short intervals,}}\pb
...
in the teeth of King Garagant\rotatebox[origin=c]{180}{u}a’s
...
\stick{the \ls{\textsc{real presence}}, “ \textit{That talking of}} 
\stick{“ \textit{love, is making it}.\,”\hfill}
...
\stick{Doctor Slop, “ if poor captain Shandy}
...
\stick{morning, “ Whether Bridget should} 
\stick{“ laugh or cry.”\hfill}
...
\stick{ often a woman’s case, “ to please others}
\stick{“ more than themselves\tsh ”\hfill}
...
\hbox to \textwidth{{\addfontfeature{LetterSpace=20}HUMANITY} - - - - - - thus.}
...
hypothesis,\pb by which means never man crucified \ls{\textsc{Truth}}

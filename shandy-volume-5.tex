...
\vfill
\centerline{\huge \lsss{JOHN},}
\vfill
\centerline{\large Lord Viscount \lss{\textsc{Spencer}}.}
\vfill
\noindent\ \textsc{My Lord},\\[-12pt]
\lettrine{I}{\ humbly} beg leave to offer you
these two Volumes; they are
the best my talents, with such bad health as I have, could produce:\tsk had
providence granted me a larger stock of either, they had been a much more proper
present to your\break Lordship.
...
\rightline{\vbox{\halign{\hfill #\cr
...
ground\tsh the motion was most rapid\tsh most
impetuous\tsh ’twas communicat-\pb ed to my
...
same way\tsk and something of every bodies!\tsh O rare!”
...
to hold\tsk aye\tsk and sublimate\pb them, \textit{shag rag and
...
\textit{La Fosseuse} uttered the word\tsh Whis-\pb kers, madam,
...
as\break \textit{De Croix} passed through it\tsk He is hand-\pb
...
their\break
\stick{chambers\tsk Whiskers! said all four of}\pb them to
...
\tsk one single denier, in behalf of a thou-\pb
...
consciousness of it, somewhere about the\pb heart, which serves
...
suffered un-\pb der such combinations.\tsh The curate of
...
afresh, when he had almost got\pb
...
Your wor-\pb ship ordered me to sell him last
...
\textit{Toby}\tsh for then\tsk I shall be a fool,\pb said my
...
his\pb heart, he has been ill enough, poor lad! I’ll answer
...
\textit{Theophras-\pb tus}, or \textit{Lucian}\tsk or some one perhaps of
...
he\pb curse it, or damn it, or excommunicate it, or rhyme it, or
lillabullero it.\tsh
...
\ls{\textsc{Marcus Tullius Cicero}}\pb could be for his
...
inconsistent in my fa-\pb ther’s domestic character; and it is
...
the death of \textit{Oba-\pb diah}\tsk and that there never would be an
...
\lqq statute in \textit{Magnâ Chartâ}\tsk it is an ever-\pb
...
\stick{\lqq together, have performed their several}\break
\newpage
\noindent\lqq evolutions, they fall back.\,”\tsk Brother\break
...
of his pipe upon my father’s hand\pb in a kindly way of
...
\lqq the world imagines\,”\tsh (this way of\pb
...
\lqq out of the world; and with reason.\tsh\pb
...
it borrows from groans\pb and convulsions\tsk and the blowing of
...
historian had a better pair of breeches!\pb
\setlength{\baselineskip}{12.7826pt}% 21*14 = 294 294/23 \simeq 12.7826 
...
\textit{Susannah}.\tsk My mother’s\pb whole wardrobe
...
or any\pb tide or time past, to this? Are we not here now,
...
corporal’s eye fixed upon it, as upon a\pb corps,\tsk and
...
which, in the former part of my work, I promised and\pb fully intended
...
\textit{William} the Third, whom I had\pb the honour to serve
...
in betwixt every two tears of\pb humiliation\tsk else no tongue
...
is.\tsk He’s nothing, \textit{Obadiah}, at all in the
...
would say to him\pb as I laid besides him. I cannot help it, \textit{Trim}, my
...
as\pb soft as a child for other people.\tsh He\break would not hurt a chicken.\tsh I would
...
\newpage
\setlength{\baselineskip}{14.7pt}  % 21*14 = 294   294/20 = 14.7 
...
all.\tsh For which reasons, I resolved from the be-\pb ginning,
...
you will readily conceive every\pb
...
temptation to it.\tsh He had wrote the 
\footnote{\enspace This book my father would never
consent to publish; ’tis in manuscript, with some other tracts
of his, in the family, all, or most of which will be printed in
due time.}
Life of \textit{Socrates}
himself the year before he left off trade, which, I\pb
...
\textit{India}, after he had\pb over-run \textit{Persia}, amongst
...
spices up the \textit{Red Sea} to \textit{Jod-\pb dah}, the port of
...
man of no deep reading, yet the abstract\pb
of
...
odds that\pb ever were laid, that I will this moment stop three hundred and fifty
...
felt,\tsk who inspires\pb me with his joys and hopes, and puts the
...
childhood and ado-\pb lescence. I was my father’s last
...
writers, he met with disappoint-\pb ments.\tsk He imagined he should
...
spent the great\-est part of his time in combing his whis-\pb kers, or
...
these great advantages of nature, which should\pb have pricked him
...
them,\tsk every thought, first and last, was captious;\tsk how spe-\pb 
...
when I come to speak of my fa-\pb ther’s religious notions, in the
...
\stick{\tsk nothing but a farrago of the clack of}\pb nurses, and of the nonsense of
...
manage, my dear,\pb for a single time to \astw4 \astw3 \astw2
\astw3\break\astw6 ?
...
blame as \textit{Susannah},\tsk and if the\pb
...
works,\tsk that we\pb have not a couple of field-pieces to mount in
...
leaden gutters,\tsk melting down his pewter shaving bason,\tsk and\pb
...
with the pullies,\break\tsk and the pullies being picked out, then\pb the
...
have happened,\tsk \textit{at least in}\pb
...
give\pb them a moment’s time to intrench themselves, they are a nation
...
that he would not suffer him to come into his presence\pb for many
...
attitudes,\tsk not one,\pb or all of them, can ever help the
reader\break
...
it for the comfort of
\footnote{\enspace Mr.\@ \textit{Shandy} is supposed to mean \astw5
\astw3\break \astw3, Esq; member for \astw6,\tsh and not the \textit{Chinese} Legislator.}
...
made so diabo-\pb lical a scream of it, as I did\tsk when the accident
...
after the event; \stick{but ’tis obviated under the second reason,}
...
arm, and \textit{Obadiah} following him with a large reading desk,
...
\stick{\astfill}\pb\enlargethispage\baselineskip
...
they should,\tsk or the lords of the genitures (as they call\pb them)
...
\vfill
\bgroup\footnotesize
\indent\lower-2pt\hbox{\ast} Χαλεπῆς νόσου, καὶ δυσιάτου ἀπαλλαγὴ, ἣν ἄνθρακα
...
is waiting for me at the door,\tsk and I\pb know the description of
...
\quad\tsh\begin{story}{which words being heard by}
all the soldiers which were there, di-\break vers of them being inwardly
terrified, did shrink back and make room for the assailant: all
this did \textit{Gymnast} very well remark and consider; and
therefore, making as if he would have a\-light\-ed from off his horse,
as he was poising himself on the mounting side, he most nimbly
(with his short sword by this thigh) shifting his feet in the\pb
stirrup, and performing the
stirrup-lea\-ther feat, whereby, after the inclining of his body
...
with his back turned towards his horse’s head,\break\tsk Now
...
into his former position, without missing one jot.\tsh\break Ha!
said \textit{Tripet}, I will not do that at this time,\tsk and not
without cause. Well, said \textit{Gymnast}, I have failed,\tsk\break I
will undo this leap; then with a\break
    marvellous strength and agility, turn-\break
    ing towards the right-hand, he fetched\break
    another striking gambol as before;\break
    which done, he set his right-hand\break
    thumb upon the bow of the saddle,\pb 
    raised himself up, and sprung into the air, poising and
upholding his whole weight upon the muscle and nerve of the
said thumb, and so turned and\break
    whirled himself about three times: at
the fourth, reversing his body, and o-\break
    verturning it upside-down, and fore-\break
    side back, without \textit{touching any thing}, he brought
...
\textit{Toby}.\tsh The corporal shook his head at
it.\tsh Have patience, said \textit{Yorick}.)

\begin{story}{Then (\textit{Tripet}) pass’d his right leg}
over his saddle, and placed himself \textit{en croup}.\tsk But,
said he, ’twere better for me to get into the saddle; then
put-\break ting the thumbs of both hands upon the crupper before him, and
thereup-\pb on leaning himself, as upon the only supporters of his
body, he incontinent-\break
    ly turned heels over head in the air,\break
    and strait found himself betwixt the\break
    bow of the saddle in a tolerable seat;\break
    then springing into the air with a sum-\break
    merset, he turned him about like a\break
    wind-mill, and made above a hundred
    \hbox to 160pt{frisks, turns, and demi-pommadas.”\tsh}
\end{story}
\noindent (Good God! cried
\textit{Trim}, losing all patience,\tsk one home thrust of a
bayonet is worth it all.\tsh I think so too, replied
\textit{Yorick}.\tsh
...
\textit{Yorick} had taken the liberty to put to him,\tsh I have\pb
...
Tom-\break fool-battle, an’ please your reverence, of\pb captain
...
subject,\tsh for the present we’ll pass them by: ’tis a prefa-\pb tory
...
ἀροτερα}.)\tsh A bull must have\pb given more trouble than his head was
...
father argutely, and 
\stick{for this plain reason \astfill}\pb
\stick{\astfill}
...
reverence does not consider, said\pb the corporal, shouldering his
...
that, \textit{Trim?} said \textit{Yorick}.\tsk He\pb did indeed, replied
...
head, said my\pb father, into a very little room, therefore
...
his right hand, (in case he had one)\tsk\pb
...
chymical nostrums, and peripatetic lumber, with\pb which, in all
...
plain; nothing more being required, says his lordship,\pb
but to
...
redundant humours,\tsk and render the system compleat.
...
also the phlegm or watery\pb parts, are cold; whereas the oily and
...
believe, continued\pb the corporal, we had both, an’ please your
...
maintain that\pb due contention betwixt the radical heat and the
...
the worst malefactors, provided they\pb
...
transitions of his\pb passions were unaccountably sudden,\tsk and
...
mouth.\tsh Then let the corporal go on,\pb
said my father,
...
it, as his honour\break could, without setting fire every night\pb to a
...
drive away the va-\pb pours\tsk we know not what it is to fear
death.
...
\textit{Tristra-pædia}.\tsh Come! chear up, my\pb lads;
...
\textit{negations}\tsk the fine statue still lying in\pb
the middle of
...
wisdom,\pb\tsk what time will he have to make use of it?}
...
have not a river or a spring running\pb besides them;\tsk every
...
done\tsh So that, ex-\pb cept \textit{Raymond Lullius}, and the
...
that as it may,\pb\tsk when the mind has done that with
...
an’ please your honour, quoth the cor-\pb
...
\textit{made};\pb \textit{suffer}; \textit{shall}; \textit{should};
...
father, in which\pb a child’s memory should be exercised, there
...
see a white bear?\pb What would they give? How would\break

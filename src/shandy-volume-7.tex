...
\centerline{\itshape\lsv{72}{ERRATA}.}

\noindent
\stick{Page\kern 3pt 33.\@ Vol.\@ VII. last line, dele \i{and}.\hfill}
\stick{Page\kern 3pt 71.\@ Vol.\@ VII. 3d line, instead of striking,}
\stick{\quad read \i{sticking}.\hfill}
\stick{Page\kern 3pt 34.\@ Vol.\@ VIII. 13th line, read \i{inflam}-}
\stick{\quad \i{matory}.}
...
\stick{have much\tskk much to thank ’em for:}
...
\indent\lqq\,\tskk There must certainly be some\break
...
\stick{in a story\tshh and I was that moment}
...
dure\tsh
\patchs[13pt]{B 2}{\lqq\tsk Did}

\topstrut\lqq\,\tskk Did ever so grave a personage\break
...
\stick{into one mass\tsh good g\bzz{od}! every thing}
...
\stick{undone! un\bzz{done}  O! undone!  sir\tsk}
\stick{What the first time?\tsh No, ’tis the se-}
\stick{cond, third, sixth, tenth time, sir,\tskk}
...
\dropcap[findent=1pt,nindent=2pt]{I}{t} is a great inconvenience to a man\break
\tight{in a haste, that there are three distinct}\break
...
\stick{of school-books hanging at his a\bzz{rse} and}
...
\stick{to swear by the living G\bzz{od}, I would rather}
...
\stick{in the map, than \s{Montreuil};\tshh I}
...
\stck{\tsk and lose thyself.\tsh I would not answer}
\stick{for my aunt Dinah, was she alive\tshh}
\stick{’faith, scarce for her picture\tshh were}
...
\baselineskip 12.5pt
\parskip 12pt
\stick{\tskk She has a little of the \i{devote:} but}
\stick{that, sir, is a terce to a nine in your}
favour\tsh

\tskk L\bzz{ord} help me! I could not count\break
...
\stick{Sir,\tshh or by Genevieve! I’ll raise a}
...
\dropcap[loversize=-.14,lraise=.3,findent=1pt,ante=\lqq]{\i{M}}{\i{ake}} \i{them like unto a wheel},\,”\break
...
\stick{their \lqq\bgroup\porson χωρισμὸν’ απὸ τοῦ Σώματος, εις’ το\egroup\sic}
\stick{\lqq \bgroup\porson Καλῶς Φιλοσοφεῖν\egroup”\tsh [their] \lqq \i{getting}}
...
\stick{from Pequignay, I got to \s{Amiens},\qquad}
\stick{\tstrut 14pt concerning which town I have nothing to}
...
\bgroup\footnotesize
\indent\fnast\enspace Chief Magistrate in Toulouse, \&c. \&c. \&c.
\par\egroup
\patch[10pt]{\lsss{CHAP}.}
...
\dropcap[loversize=-.2,lraise=.3]{T}{he} abbess of Andoüillets, which\break
...
\baselineskip 13.6667pt
\parskip 8pt
\stick{\lqq get on”\tshh so slinking behind, he en-}
\stick{ter’d the little inn at the foot of the hill.}
...
\tsh The old mule let a f\bzz{art}
\patch[10pt]{\lsss{CHAP}.}
...
\stick{\hbox to 38pt{\i{Margarita},}\tbrace\,\tskk ger, ger, ger, ger, ger, ger.}
\par\egroup
...
\dropcap[nindent=2pt]{W}{hat} a tract of country have I\break
...
\stick{\astW3 \astW6;\tskk\astW4 \astW2 \astW4}
\catch{\tsh any}
...
\stick{I fear with some irreverence\tshh \lqq I\sic}
...
\patchs[56pt]{I 3}{\lsss{CHAP}.}
\parskip 12pt

\chap{XXXII}{21pt}{4pt}

\dropcap[ante=\lower5pt\hbox{\tsh\huge ’}]{T}{was} by a poor ass who had\break
...
\tshh If I do, said I, I’ll be d\bzz{amn’}d.
...
\tight{post-office would have his six livres}\break
...
\stick{\tsk and then left me bare a\bzz{rs}’d after\tsk I}
...
\dropcap[findent=1pt,nindent=0pt]{W}{\lsss{hen}} the first transport was\break
...
the Rhône, before I made it\tush

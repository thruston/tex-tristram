...
%\usepackage[a6paper, width=166pt, height=266pt]{geometry} 
...
\usepackage{graphicx}
\usepackage{shandean}
\def\catch#1 {\setbox0=\hbox{\lower12pt\llap{#1}}\ht0=0pt
\dp0=0pt\box0\break\eject\noindent}
...
\lettrine[findent=4pt, lraise=0.05]{H}{\lsss{\large aving}}, \textit{a priori},
intended\break
...
their Reverences; because, \textit{a posteri}-\catch{\textit{ori,}} \textit{riori}
...
\lettrine[findent=7pt, lraise=0.05]{I}{\lss{\large call}} all the powers of time and
...
\lettrine[findent=3pt, lraise=0.05]{T}{\lss{\large hough}} the Corporal had been as good
...
\lettrine[findent=2pt, lraise=0.05]{M}{\large y} uncle Toby turn’d his
...
\lettrine[findent=2pt, lraise=0.05]{S}{\lss{\large he}} cannot, quoth my uncle
...
\lettrine[findent=0pt, lraise=0.05]{A}{\large s} Tom’s place, an’ please your
...
\lettrine[findent=3pt, lraise=0.05]{W}{\lss{\large hen}} Tom, an’ please
...
\lettrine[findent=0pt, lraise=0.05]{A}{\large s} Tom, an’ please your honour,\break had no business at that time with the
...
\lettrine[findent=0pt, lraise=0.05]{A}{\lss{\large ll}} womankind, continued Trim,
...
\lettrine[findent=3pt, lraise=0.05]{N}{\lss{\large ow}}, for what the world thinks of
...
\lettrine[findent=2pt, lraise=0.05]{M}{\large y} mother had gone with her left arm twisted in my father’s right, till
...
\lettrine[lraise=0.07,findent=2pt, nindent=0pt]{\Tsk {\normalsize\lower -11pt \hbox{\lqq }\ }N}{\,\lss{\large ow}}\nobreak
...
\lettrine[findent=3pt, lraise=0.05]{U}{\lss{\large pon}} looking back from the end\break of the last chapter, and surveying
...
\lettrine[findent=3pt, lraise=0.05]{N}{\lss{\large ow}} in ordinary cases, that is, when
...
\lettrine[findent=0pt, lraise=0.05, nindent=8pt]{A}{\large s} I never had any intention of
...
\lettrine[findent=3pt, lraise=0.05]{T}{\lss{\large he}} fifteenth chapter is come at
...
\lettrine[findent=3pt, lraise=0.05]{W}{\lss{\large hen}} my uncle Toby and the\break
...
\lettrine[findent=0pt, lraise=0.05]{A}{\large s} Mrs.\@ Bridget’s finger
...
\lettrine[findent=0pt, lraise=0.05]{A}{\large s} there are fifty different ends\break
...
\lettrine[findent=3pt, lraise=0.05]{W}{\large e} live in a world beset on all
...
\lettrine[findent=1pt, lraise=0.05]{M}{\lss{\large rs}}.\@ Bridget had pawn’d
...
\lettrine[findent=.5pt, lraise=0.01, loversize=0.05]{\Tsk\kern-2pt A}{\lss{\large nd}} the story too\tsk if you\break
...
\lettrine[findent=1pt, lraise=0.05]{G}{\lss{\large entle}}
...
\lettrine[findent=3pt, lraise=0.05]{W}{\lss{\large hen}} we have got to the end of this
...
the foam of Zeuxis his horse; besides, I look upon a chapter\etp\catch{which} which has,
\textit{only nothing in it}, with re-\break
...
for my reply, shall I be call’d as many blockheads, num-\break sculs,
doddypoles, dunderheads, ninny-hammers, goosecaps, joltheads,
nincompoops, and sh-\kern 0.08em -t-a-beds\tsh and other unsavoury
appellations, as ever the cake-\break bakers of Lernè, cast
in the teeth of\break King Garagant\rotatebox[origin=c]{180}{u}a’s
shepherds\tsh And\break I’ll let them do it, as
Bridget said, as much as they please; for how was it
possible they should foresee the necessity I\catch{was} was under of writing
...
\lettrine[findent=0pt, lraise=0.05]{A}{\large s} Mrs.\@ Bridget open’d the
...
\lettrine[findent=3pt, lraise=0.05]{N}{\lss{\large ow}} there are such an infinitude of
...
\lettrine[findent=3pt, lraise=0.05]{I}{\large t} is natural for a perfect stranger
...
\lettrine[findent=3pt, lraise=0.05, nindent=0.5pt]{M}{\large y} uncle Toby’s Map is
...
\lettrine[findent=1pt, lraise=0.04]{\Tsk\kern-1.6pt A}{\ls{\large nd}} here is the
...
slightly \rlap{press’d}\\the back of her hand towards the part he
felt for\tsh and let it fall.\patch{We}
...
\lettrine[findent=3pt, lraise=0.05]{I}{\large t} was like the momentary contest in
...
\lettrine[findent=2pt, lraise=0.05]{M}{\large y} uncle Toby and the Corporal
...
\lettrine{N}{\;\lss{ow}} my uncle Toby had one
...
\lettrine[findent=3pt, lraise=0.05]{T}{\lss{\large here}} will be just time, whilst\break my
...
\lettrine[findent=2pt, lraise=0.05]{\Tsk\kern-3pt T}{\lss{\large hat}} 
provision should be

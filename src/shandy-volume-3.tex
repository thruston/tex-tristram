...
\initial[findent=0pt]{\Usk{16pt}\rlap{\large\lqq}%
\lower-10pt\hbox{\large\lqq}\itshape A}{\textit{\lss{LL}}}
\textit{is not
...
\initial[findent=2pt, nindent=1pt]{\Usk{18pt}\raise10.4pt\hbox{\large\lqq}B}{\lsss{ECAUSE}},\,”
...
\initial[findent=2pt]{\Usk{24pt}W}{\lss{HAT}} an unconscionable\break
...
\initial{\lower-10pt\hbox{\large “}\itshape N}{\textit{\lss{IHIL}}}

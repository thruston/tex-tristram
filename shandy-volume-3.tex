...
\lettrine{\Tsk\lower-10pt\hbox{\large “}\textit{I}}{\,\textit{wish},}
Dr.\@ \textit{Slop},” quoth my\break
uncle \textit{Toby}, (repeating his wish for Dr.\@ \textit{Slop} a second time,
and with a degree of more zeal and earnestness in his manner of wishing, than he had
wished it at first \footnote{\ Vid. Vol. II. p.\,159})\tsh “\textit{I wish}, Dr.\@ \textit{Slop},” \textit{quoth} my
uncle \textit{Toby}, “\textit{you had seen what}\break
\rlap{“}\kern 0.6em \textit{prodigious armies we had in Flanders}.”

\newpage
My uncle \textit{Toby}’s wish did Dr.\@ \textit{Slop} a disservice which his
heart never intended any man,\tsh Sir, it confounded him\tsh and thereby putting his
ideas first into confusion, and then to flight, he could not rally them again for
the soul of him.

In all disputes,\tsh male or female,\tsh whether for honour, for profit or for
love,\break
\tsk it makes no difference in the case;\tsk nothing is more dangerous, madam, than a
wish coming sideways in this unexpect\-ed manner upon a man: the safest way in general
to take off the force of the wish, is for the party wished at, instantly to get upon
his legs\tsk and wish the \textit{wisher} something in return, of pretty near the same
value,\tsk so balancing the account upon the spot, you stand as you were\tsk nay
...
Dr.\@ \textit{Slop} did not understand the nature of this defence;\tsk he was puzzled with it, and it
put an entire stop to the dispute for four minutes and a half;\tsk five had been fatal
to it:\tsk my father saw the danger\tsk the dispute was one of the most interesting
disputes in the world,\break
\lqq Whether the child of his prayers and
\stick{endeavours should be born without a} head or with one:”\tsk he waited to the last moment, to allow Dr.\@ \textit{Slop}, in
whose behalf the wish was made, his right of returning it; but perceiving, I say,
that he was confounded, and continued looking with that perplexed vacuity of eye
which puzzled souls generally stare with,\tsh first in my uncle \textit{Toby}’s face\tsk
then in his\tsk then up\tsk then down\tsk then\pb east\tsk east and by east, and so on,\tsh
coasting it along by the plinth of the wainscot till he had got to the opposite
point of the compass,\tsh and that he had actually begun to count the brass nails
upon the arm of his chair\tsk my father thought there was no time to be lost with my
uncle \textit{Toby}, so took up the discourse as follows.



\section{\lsss{CHAP}.\quad  II.}

\lettrine{\lower-10pt\hbox{\large “}%
\leaders\hrule width 1pt height 14.14pt depth -13.4pt\hskip .5em\thinspace W}{\,\lsss{hat}}
prodigious armies\break you had in \textit{Flanders!}”\tsh

Brother \textit{Toby}, replied my father, taking his wig from off
his head with his right hand, and with his \textit{left} pulling out a
striped \textit{India} han
dkerchief from his right coat pocket, in
order to rub his head,\pb as he argued the point with my uncle
\textit{Toby.}\tsh

\tsh Now, in this I think my father was much to blame;
and I will give you my reasons for it.

Matters of no more seeming consequence in themselves than, \lqq\textit{Whether my
father should have taken off his wig with his right hand or with his left},”\tsh have
divided the greatest kingdoms, and made the crowns of the monarchs who governed
them, to totter upon their heads.\tsk But need I tell you, Sir, that the
circumstances with which every thing in this world is begirt, give every thing in
this world its size and shape;\tsk and by tightening it, or relaxing it, this way or
that, make the thing to be, what it is\tsh\break
great\tsk little\tsk good\tsk bad\tsk indifferent\pb
...
In this case, (unless, indeed, my father\pb had been resolved to make a fool of himself
...
\lettrine{I}{\,t} was not an easy matter in any
...
his map of \textit{Namur}, and his compasses and sector\pb along with
...
\lettrine{A}{ man}’s body and his mind, with
...
that is,\pb when you are so fortunate a fellow, as to have had your
jerkin made of gum-taffeta, and the body-lining to it of a
sarcenet, or thin persian.

\textit{Zeno}, \textit{Cleanthes}, \textit{Diogenes Babylonius}, \textit{Dionysius},
\textit{Heracleotes}, \textit{Antipater}, \textit{Panætius}, and
...
this sort:\tsh\break for never poor jerkin has been tickled off
at such a rate as it has been these last nine months
together,\tsh and yet I declare, the lining to
it,\tsh as far as I am a judge of the
...
Review-\pb ers!\tsh how could you cut and slash my jerkin as
...
devil,\,” quoth he, “\tsh get thee gone,\tsh why\pb
\stick{\lqq should I hurt thee! This world is surely}
\stick{\lqq wide enough to hold both thee and me.”}

\section{\lsss{CHAP}.\quad  V.}

\lettrine{A}{\ls{ny}} man, madam, reasoning up-\break wards,
and observing the prodi-\break
...
rage; and taking that for granted,\tsh\pb
...
blamed nothing but the taylor who cut the pocket-hole;\tsh so sitting still, till\pb
...
\lettrine{\null\nobreak\leaders\hrule width 1pt height 14.14pt depth -13.4pt\hskip
.8em
\lower-10pt\hbox{\large “}\kern.1em W}{\,\lsss{hat}}
...
\stick{the accidents which unavoidably way-lay}
\stick{them, not only in the article of our beget-}
\stick{ting ’em,\tsk though these, in my opinion,}\pb
are well worth considering,\tsh but the dangers and difficulties our children are
beset with, after they are got forth into the world, are enow,\tsk little need is
there to expose them to unnecessary ones in their passage to it.\tsk Are these
dangers, quoth my uncle \textit{Toby}, laying his hand upon my father’s knee, and
looking up \stick{seriously in his face for an answer,\tsk are}
\stick{these dangers greater now o’\, days, bro-}
ther, than in times past? Brother \textit{Toby}, answered my father, if a
child was but fairly begot, and born alive, and healthy, and the mother did well
after it,\tsk our forefathers never looked farther.\tsh My uncle \textit{Toby}
instantly withdrew his hand from off my father’s knee, reclined his body gently back
in his chair, raised his head till he could just see the cornish of the room, and
then directing the buccina-\break tory muscles along his cheeks, and the\pb orbicular muscles
around his lips to do their duty\tsk he whistled \textit{Lillabullero.}

\section{\lsss{CHAP}.\quad  VII.}

\lettrine{W}{\,\ls{hilst}} my uncle \textit{Toby} was
...
When Dr.\@ \textit{Slop}’s maid delivered the green bays bag with her master’s instruments in it,
to \textit{Obadiah}, she very sensibly exhorted him to put his head and one arm
through the strings, and ride with it slung across his body: so undoing the\pb
bow-knot, to lengthen the strings for\break
him, without any more ado, she helped him on
with it. However, as this, in some measure, unguarded the mouth of the bag, lest any
thing should bolt out in galloping back, at the speed \textit{Obadiah} threatened,
they consulted to take it off again; and in the great care and caution of their
hearts, they had taken the two strings and tied them close (pursing up the mouth of
the bag first) with half a dozen hard knots, each of which, \textit{Obadiah}, to make
all safe, had twitched and drawn together with all the strength of\break his body.

This answered all that \textit{Obadiah} and the maid intended; but
...
had\pb so much room to play in it, towards the bottom, (the
shape of the bag being conical) that \textit{Obadiah} could not make
a trot of it, but with such a terrible jingle, what with the
\textit{tire-téte}, \textit{forceps}, and \textit{squirt}, as would have
been enough, had \textit{Hymen} been taking a jaunt that way, to have
frightened him out of the country; but when \textit{Obadiah}
accelerated his motion, and from a plain trot assayed to prick his
coach-horse into a full gallop\tsk by heaven! Sir,\tsk the
...
to himself, and weigh\-ed with him, as it has oft-times done with\pb
the greatest patriots.\tsk“\textit{The poor fellow, Sir, was
not able to hear himself whistle.}”

\section{\lsss{CHAP}.\quad  VIII.}

\lettrine{A}{s} \textit{Obadiah} loved wind musick pre\-ferably to all the instrumental
mu\-sic he carried with him,\tsk he very considerately set his imagination to work, to
...
\stick{apt to enter a man’s head as his hat-band:}
\tsh the philosophy of this is so near the
surface\tsk I scorn to enter into it.

As \textit{Obadiah}’s was a mix’d case\tsh mark,
Sirs,\tsh I say, a mix’d case; for it\pb was
obstetrical,\tsh \textit{scrip}-tical, squirtical,
papistical\tsh and as far as the coach-horse
...
of the other, \stick{putting the end of the hat-band betwixt his} teeth, and
...
unloosed them.\tsk I think in my con-\break science, that had
\textsc{Nature} been in one of\pb
...
of small accidents, \textit{Tristram Shandy!} that thou art, and ever
will be! had that trial been for thee, and it was fifty to one but
it had,\tsh thy affairs had not been so
depress’d\tsk (at least by the depression of thy nose) as
they have been; nor had the fortunes of thy house and the occasions
of making them, which have so often presented themselves in the\pb
\stick{course of thy life, to thee, been so often,}
\stick{so vexatiously, so tamely, so irrecoverably}
...
\lettrine{G}{\lss{reat}} wits jump: for the moment Dr.\@ \textit{Slop} cast his eyes upon his bag (which he
had not done till the dispute with my uncle \textit{Toby} about mid-wifery put him
in mind of it)\tsh the very same thought occurred.\tsh ’Tis God’s mercy, quoth he (to
...
got untied.\tsh But\pb here you must distinguish\tsh the\break
thought floated only in Dr.\@ \textit{Slop}’s mind,\break
without sail or ballast to it, as a simple proposition;
millions of which, as your worship knows, are every day swimming quietly in the
...
A sudden trampling in the room above, near my mother’s bed, did the proposition the
very service I am speaking of. By all that’s unfortunate, quoth Dr.\@ \textit{Slop}, unless I make
haste, the thing will actually befall me as it is.

\newpage
\section{\lsss{CHAP}.\quad  X.}

\lettrine{I}{\,n} the case of \textit{knots},\tsh by which, in the first place, I would not
be understood to mean slip-knots\tsk because in the course of my life and
opinions\tsh\break
...
made by the second\break\textit{implication} of them\tsk to get them slipp’d and undone by\tsh I hope you ap-\break prehend me.
...
his favourite instrument,\pb by extracting in a wrong direction, or by some
...
within fifty miles\tsh I am undone for this bout\tsk I wish the scoundrel hang’d\tsh I
wish he was shot\tsh I wish\pb all the devils in hell had him for a blockhead\tsh
...
curse at all\tsh I hold it bad\tsh but if I fall into it,
...
reason, continued my father, with the most \textit{Cer\-vantick}
...
provocation which could possibly happen to him\tsh which forms being well considered
...
ber right, ’tis too violent for a cut of the\pb
...
\newpage
\centerline{Textus de Ecclesiâ Roffensi,}
\centerline{per Ernulfum Episcopum.}
\bigskip
\bigskip
\centerline{\large\lsss{CAP}. XXV.}
\bigskip
\centerline{\large\lsss{EXCOMMUNICATIO}.}

\lettrine{E}{x} auctoritate Dei omnipotentis, Patris, et Filij, et Spiritus Sancti, et
...
\egroup
\def\alt#1#2{\hbox{\vbox to 2ex{\vss\openup-7pt\halign{##\cr\hss\tiny #2\hss\cr#1\cr}}}}
\newpage
\section{\lsss{CHAP}.\quad  XI.}

\lettrine{{\large\rlap{“}\lower-10pt\hbox{“\,}}B}{y}
...
read it aloud\tsh\break and as Captain \textit{Shandy} seems to have no great inclination
...
innocentum, qui in conspectu Agni soli\pb
over whistling, and read it himself to
them;\tsh Dr.\@ \textit{Slop} thought he might as
well read it under the cover of my uncle \textit{Toby}’s whistling\tsk as
suffer my uncle \textit{Toby}
to read it alone;\tsh so raising up the paper to his
face, and holding it quite parallel to it, in order to hide his chagrin\tsh\break
he read it aloud as follows\tsh my uncle \textit{Toby} whistling Lillabullero,
though not quite so loud as before.

\begin{story}{By the authority of God Almighty,}
the Father, Son, and Holy Ghost, and
of the undefiled Virgin \textit{Mary}, mother and patroness of our Saviour, and
of\break
    all the celestial virtues, angels, arch-\break
    angels, thrones, dominions, powers,\break
    cherubins and seraphins, and of all the\break
    holy patriarchs, prophets, and of all\break
    the apostles and evangelists, and of the\break
    holy innocents, who in the sight of\pb
\end{story}
...
anathematizamus \alt{hunc}{vel os} fure\alt{m}{s}, vel \alt{hunc}{vel os}\break
malefactore\alt{m}{s}, N.\,N.\, et a liminibus sanctæ\break
Dei ecclesiæ sequestramus, et æternis\break
suppliciis excruciand\alt{us}{i}, mancipe\alt{t}{nt}ur, cum\break
...
lucerna \alt{ejus}{eorum} in secula seculorum nisi re-\break
spuerit, et ad satisfactionem veneri\alt{t}{nt}.\break
Amen.
...
\stick{qui sua prædicatione mundum universum}
...
\newpage\noindent
\stick{\indent\lqq May St.\@ John, the Præcursor, and}
...
Maledictus si\alt{t}{n} ubicunque, fueri\alt{t}{n}, sive in domo, sive in agro, sive in viâ, sive in
...
\stick{\tsk\ \tsh\ \tsh\ \tsh\ \tsh\ \tsh}
manducando, bibendo, esuriendo, siti-\break
endo, jejunando, dormitando, dormiendo,\break
vigilando, ambulando, stando, sedendo,\pb
...
Maledict\alt{us}{i} si\alt{t}{n} in totis viribus corporis.
...
Maledicat illum Christus Filius Dei\break vivi toto suæ majestatis imperio\\
\newpage
\noindent
...
every beard of which claimed the rights and privileges of being stroken and sworn
by\tsk\pb
\null
\vfill
\noindent
...
stood by, and heard my uncle \textit{Toby}’s accompanyment.]

\tsh “Curse him”\tsh continued\break
Dr.\@ \textit{Slop},\tsk\lqq and may heaven with\break
...
\tsh So am not I, replied my uncle.\tsh\pb
...
\lettrine{N}{\,\ls{ow}} don’t let us give ourselves a\break
...
spirit to swear them,\tsh imagine that we have had the wit
to invent them too.
...
metaphor, which by the bye is a pity\tsh for I have
...
\tsk And how did \textit{Garrick} speak the soliloquy last
night?\tsk Oh, against all rule, my Lord,\tsk most
ungrammatically! be-\pb twixt the substantive and the adjective, which
...
\stick{likewise? Did no expression of attitude or}
\stick{countenance fill up the chasm?\tsh Was}
\stick{the eye silent? Did you narrowly look?\tsh}
...
quite an irregular thing!\tsk not one of\pb
...
me,\tsk I ask no more, but one stroke of native humour, with\pb
...
originals,\tsh except St.\@ \textit{Paul}’s
\textit{thumb}\tsh \textit{God’s flesh and God’s fish}, which were oaths
mo-\break
narchical, and, considering who made\break
them, not much amiss; and as kings\break
oaths, ’tis not much matter whether they\break
were fish or flesh;\tsk else, I say, there is not an oath, or at least a curse
...
infinitely short of the force and spirit\pb
...
My father, who generally look’d upon\pb every thing in a
...
an oath, from\pb the great and tremendous oath of \textit{William} the
...
\lettrine{\Tsk B}{less} my soul!\tsk my
poor mistress is ready to faint,\tsk
...
\tsh (and I, my thumb, cried Dr.\@ \textit{Slop})\pb
and the child is where it was,
continued \textit{Susannah},\tsk and the midwife has fallen
backwards upon the edge of the fender, and bruised her hip as black
as your hat.\tsk I’ll look at it, quoth Dr
\textit{Slop}.\tsk There is no need of that, replied
\textit{Susannah},\tsk you had better look at my mistress,\tsk but
...
quoth my uncle \textit{Toby},\tsk and but for it,\pb
...
reflection; though full as hobby-hor\-sical himself)\tsh do I know, Captain
...
\lettrine{L}{\,\ls{et}} us go back to the
...
second \textit{Philippick}\tsh it must certainly have beshit the
orator’s\pb
mantle.\tsk And then again, if too old,\tsk it must have been
unwieldly and incommodious to his action\tsk so as to make him
lose by his child almost as much as he could gain by it.\tsk
Otherwise, when a state orator has hit the precise age to a
minute,\tsk hid his BAMBINO in his mantle so cunningly that no
mortal could smell it,\tsk and produced it so critically,
\stick{that no soul could say, it came in by head}
and shoulders,\tsk Oh, Sirs!\@ it has done wonders.\tsh It has open’d the sluices, and
turn’d the brains, and shook the\break principles, and unhinged the
politicks of\break half a nation.
...
yards of good\pb purple, superfine, marketable cloth in\break
them\tsh with large flowing folds and doubles, and in a great style of
design.\break\tsh All which plainly shews, may it please your
worships, that the decay of eloquence, and the little good
service it does at present, both within, and without doors, is
owing to nothing else in the world, but short coats, and the
disuse of \textit{trunk-hose}.\tsh We can conceal nothing under
ours, Madam, worth shewing.

\enlargethispage{\baselineskip}
\section{\lsss{CHAP}.\quad  XV.}

\lettrine{D}{r}.\@ \textit{Slop} was within an ace of
...
would end in his new\pb invented \textit{forceps}, he thrust his hand into the
...
overthrown: the sentence and\break the argument in that case jumping
closely in one point, so like the two lines which form the salient
angle of a raveline,\tsk Dr.\break \textit{Slop} would never have
given them up;\tsh and my uncle \textit{Toby} would as soon
...
law in disputation That the respondent may reply to which\pb
...
\lettrine{\Tsk U}{\,\ls{pon}} my honour, Sir, you have tore
every bit of skin quite off the back of both my hands with your
forceps, cried my uncle \textit{Toby},\tsk and you have crush’d
all my knuckles into the bargain with them to a jelly. ’Tis your
...
suffi-\pb ciently arm’d, or the rivet wants closing\tsk or else
...
my child’s head piece.\,\tsh\, It would not have been a cherry stone
the worse, answered Dr.\@ \textit{Slop}.\tsk I maintain it, said
...
an apple;\tsk the sutures give way,\tsk and besides, I could have
extracted by the feet after.\tsk Not you, said she.\tsh I rather
...
\lettrine{\hskip-3pt\Tsk A}{\hskip-2pt\ls{nd}} pray, good woman,
after all, will you take upon you to say, it may not be the
child’s hip, as well as the child’s
head?\tsh ’Tis most certainly the head, replied the
midwife. Because, continued Dr.\@ \textit{Slop} (turning to my father)
as positive as these old ladies generally are,\tsh ’tis a
point very difficult to know\tsk and yet of the greatest
consequence to be known;\tsh because, Sir, if the hip is
mistaken for the head\tsk there is a possibility (if it is a boy)
that\break
...
\lettrine{I}{\,t} is two hours, and ten
minutes,\tsk\break
and no more,\tsh cried my father, looking at his
watch, since Dr.\@ \textit{Slop} and\pb
\textit{Obadiah} arrived, \tsh and I
know not how it happens, brother \textit{Toby}, \tsh\break but to my
...
\textit{duration}\pb
\textit{and its simple modes}, in order to shew my uncle \textit{Toby}
...
succession of ideas, and had not the least appre-\pb hension of having
...
whether they were born with us,\tsk or we picked them up
afterwards as we went along,\tsk or whether we did it
\stick{in frocks,\tsk or not till we had got into}
\stick{breeches,\tsk with a thousand other inquiries}
and disputes about
...
he\pb was disappointed, with my uncle’s fortuitous solution.
...
exchange it for a know\-ledge.\tsh But I’ll tell thee.\tsh

\newpage
To understand what \textit{time} is aright, without which we
never can comprehend \textit{infinity}, insomuch as one is a
portion of the other,\tsk we ought seriously to sit down and
consider what idea it is we have of \textit{duration}, so as to
give a satisfactory account how we came by it.\tsk What is that
to any body? quoth my uncle \textit{Toby}.\break{}\footnote{\ Vid. Locke.}
\textit{For if you will turn your eyes inwards}
\stick{\textit{upon your mind}, continued my father, \textit{and}}\break
\textit{observe attentively, you will
perceive, bro\-ther, that whilst you and I are talking together,
\hbox to 140pt{and thinking and smoaking our pipes:}\break
\stick{or whilst we receive successively ideas in our}
minds, we know that we do exist, and so we
\stick{estimate the existence, or the continuation of}
\stick{the existence of ourselves, or any thing else}
commensurate to the
succession of any ideas in our minds, the duration of ourselves,
or any such other thing co-existing with
our}\pb\textit{thinking,\tsh and so
...
\textit{Toby}.\tsk A train\pb of a fiddle stick!\tsk quoth my
...
are more like a smoak-jack.\tsh Then, bro\-ther \textit{Toby},
...
\lettrine{\Tsk W}{\,\ls{hat}} a conjuncture was
here lost!\tsh My father in one of his best explanatory
...
smoak-jack;\break
\tsh the funnel unswept, and the ideas\pb
...
and dearer \textit{Cervantes},\tsh my father and my uncle \textit{Toby}’s discourse
upon \textsc{time} and \textsc{eternity},\tsh was a discourse devoutly to be wished
...
\lettrine{T}{\,\ls{ho}’} my father persisted in not going on
with the discourse\tsk yet he could not get my uncle
\textit{Toby}’s smoak-\pb jack out of his head,\tsk piqued as he was
...
had not made a dozen revolutions, before\pb
he fell asleep also.\tsh Peace be with
them both.\,\tsk\, Dr.\@ \textit{Slop} is engaged with the midwife
and my mother above stairs.\tsk\break
\textit{Trim} is busy in
turning an old pair of jack-boots into a couple of mortars, to be
employed in the siege of \textit{Messina} next summer,\tsk and is
this instant boring the touch holes with the point of a
hot\break
poker.\tsh All my heroes are off my
hands;\tsh ’tis the first time I have had a moment to
spare\tsk and I’ll make use of it, and write my
preface.
...
\lettrine{N}{\,o}, I’ll not say a word about it\tsk\break
...
had thought fit originally to give\pb
me\tsh so that, as your
worships see\tsk ’tis just as God pleases.

\noindent
\stick{\hfill Now, \textit{Agalastes} (speaking dispraisingly)}
...
from each other as wide as east from west\tsk So, says
\textit{Locke},\tsk so are farting and hickuping, say I. But
in answer to this, \textit{Didius} the great church \stick{lawyer, in his
code \textit{de fartandi et illustrandi}}\break\textit{fallaciis}, doth maintain and
...
please your wor-\pb ships, see the better for it\tsh so that
...
friend;\tsk \textit{Phutato\-rius}, my
guide;\tsk \textit{Gastripheres}, the preserv\-er of my life;
\textit{Somnolentius}, the balm and repose of it,\tsk not
forgetting all others as well sleeping as waking,\tsk ecclesiastical
as civil, whom for brevity, but out of no\pb
...
dying,\tsk I am gone.\tsk Help! Help! Help!\tsk But
hold,\tsk I grow something better again, for I am beginning to
foresee, when this is over, that as we shall all of us conti-\pb
nue to
...
all courtesy\pb and kindness,\tsh milk and honey,\tsh ’twould be a
...
worships well know, that of these \stick{heavenly emanations of \textit{wit} and
\textit{judgment},} which I have so bountifully wished both for your
...
intervals from each other, that one would\pb wonder how it holds out,
...
to nothing,\tsk and where the passions of a man, with every thing
...
is a total and an absolute saving,\tsk for as not one spark\pb
...
near half a\pb century together, there shall be very little wit or
...
posts, and knocking out\pb
their brains without ever getting to their
journies end;\tsk some falling with their noses
...
ing full but against the other half of it, and then tumbling
...
In the foreground of this picture, a \textit{statesman} turning the political wheel, like a
brute, the wrong way round\tsh \textit{against} the stream
of corruption,\tsk by heaven!\tsh instead of \textit{with}
it.
...
all their might and main, the wrong way;\tsh kicking it \textit{out} of
the great doors, instead of, \textit{in},\tsh and with such fury in their
looks, and such a de-\pb gree of inveteracy in their manner of kicking it, as if the
laws had been originally made for the peace and preservation of
mankind:\tsh perhaps a more enormous mistake committed by them
still,\tsk a li\-tigated point fairly hung up;\tsk for in\-stance,
Whether \textit{John o’Nokes} his nose could stand in \textit{Tom
o’Stiles} his face, without a trespass, or not,\tsk rashly
...
carried on upon a military plan, as \stick{your honours know, an
...
advantages on both sides,\tsh might\pb
...
shot.\tsh I have no desire; and besides, if I had,\break \tsk I durst not for my
...
\textit{judgment}.\tsh But mark\tsk\pb
I say, \textit{reported to be}\tsk for it is no more, my dear Sirs, than a report,
and which, like twenty others taken up every day upon trust, I maintain to be a vile
and a malicious report into the bargain.

This by the help of the observations\break
already premised, and I hope already\break
weighed and perpended by your reverences and
worships, I shall forthwith\break make appear.

I hate set dissertations\tsh and above all things in
...
looked about you,\pb might have seen something standing, or hanging
up, which would have cleared the point at
once\tsk
\begin{story}{for what hinde-}
    rance, hurt, or harm doth the
...
a pot, a fool, a stool, a winter-mittain, a truckle for a pully,
    ...
    \hbox to 160pt{bottle, an old
    slipper, or a cane chair,”}
\end{story}\noindent
\tsk I am this moment
...
it,\tsh\break they are fasten’d on, you see, with two pegs stuck
...
\tsk Here stands \textit{wit},\tsk and there stands
\textit{judgment}, close beside it, just like the two knobs I’m
...
let us for a moment, take off one of
these two curious ornaments (I care not which) from the point or
pinnacle of the chair it\pb now stands on;\tsh nay, don’t laugh
at it.\tsk But did you ever see in the whole course of your
lives, such a ridiculous business as this has made of
it?\tsk Why, ’tis as miserable a sight as a sow with one
ear; and there is just as much sense and symmetry in the one, as in
the other:\tsk do,\tsk pray, get off your seats,
only to take a view of it.\tsh Now would any man who
valued his character a straw, have turned a piece of work out of
his hand in such a condition?\tsk nay, lay
\stick{your hands upon your hearts, and answer} this plain question, Whether this
one
...
the other;\tsh and let me farther ask, in case the chair was your
own, if you would not in your consci\-ences think, rather than be as
it is, that\pb it would be ten times better without any knobb at
all.

Now these two knobs\tsh or top ornaments of the mind of
man, which crown the whole entablature,\tsk being, as I
said, wit and judgment, which of all others, as I have proved it,
are the most needful,\tsh the most priz’d,\tsh the
most calamitous to be without, and consequently the hardest to come
at,\tsk for all these reasons put together, there is not a mortal
amongst us, so destitute of a love of good fame or
feeding,\tsh or so ignorant of what will do him good
therein,\tsk who does not wish and stedfastly resolve in his own
mind, to be, or to be thought at least, master of the one or the
other, and indeed of both of them, if the thing seems any way
feasible, or likely to be\break brought to pass.
...
who was sel-\pb dom outwitted by false
...
rendered so general a one against the \textit{poor wits} in this
...
since,\tsh but your reve-\pb rences plainly see, it has been
...
further than when I see they are bespoke and let grow on purpose to
...
\lettrine{E}{\,\ls{very}} day for at least ten years together did my
father resolve to have it mended,\tsh ’tis not mended yet;\tsh
no family but ours would have borne with it an hour,\tsk and
what is most astonishing, there was not a subject in the world
upon which my father was so eloquent, as upon that of
...
\newpage
\tsh Inconsistent soul that man
is!\tsh languishing under wounds, which he has the power
to heal!\tsk his whole life a contradiction to his
knowledge!\tsk his reason, that precious gift of God to
him\tsk (instead of pouring in oyl) serving but to sharpen his
sensibilities,\tsk to multiply his pains, and render him more
melancholy and uneasy under them!\tsk Poor unhappy creature, that
he should do so!\tsh Are not the necessary causes of
misery in this life enow, but he must add voluntary ones to his
stock of sorrow;\tsk struggle against evils which cannot be
...
oyl to be got, and a hammer to be found within ten miles\pb of
\textit{Shandy Hall}\tsh the parlour-door hinge shall be
mended this reign.

\section{\lsss{CHAP}.\quad  XXII.}

\lettrine{W}\,\ls{{hen}} Corporal \textit{Trim} had brought
...
arms to take his nap after dinner, but the thoughts of be-\pb
...
hastily.\tsh If Dr.\@ \textit{Slop} has any\pb
...
\textit{Toby},\tsk they were \textit{hereditary}. Then I fear,
quoth my uncle \textit{Toby}, \textit{Trim}
...
brother,\pb ever since the civil wars;\tsk Sir \textit{Roger
...
guineas for your \textit{pontoons};\tsk half as much for\pb
\stick{your \textit{Dutch}-draw-bridge;\tsk to say nothing}
\stick{ofthe train of little brass-artillery you be-}
\stick{spoke last week, with twenty other prepa-}
\stick{rations for the siege of \textit{Messina}; believe me,}
\stick{dear brother \textit{Toby}, continued my father,}
\stick{taking him kindly by the hand,\tsk these mi-}
\stick{litary operations of yours are above your}
\stick{strength;\tsk you mean well, brother,\tsk but}
\stick{they carry you into greater expences than}
\stick{you were fitst aware of,\tsk and take my}
...
simplicity of \textit{Trim},\tsh and the generous\pb
...
\lettrine{A}{\ls{ll}} is quiet and hush, cried my\break
...
\stick{\tsh not one single thing has gone right}
this day! had I faith in astrology, bro\-ther, (which, by
the bye, my father had)\pb
...
understand how my uncle \textit{Toby} could mistake the
bridge,\tsk I fear I must give you an exact account of the road
which led to it;\tsk or to drop my metaphor (for\pb
...
O ye \textsc{Powers}! (for powers ye are, and great ones too)\tsk which
...
I beg and beseech you (in case you\pb
...
a guide-post in the centre of them, in mere charity, to direct
an uncertain devil which of the three he is to take.

\section{\lsss{CHAP}.\quad  XXIV.}

\lettrine{T}{\,\ls{ho}}’ the shock my uncle \textit{Toby} re-\break
...
concurrence of circumstances, which in-\pb sensibly drew him in, to lay
...
it,\tsk that so many play-wrights, and\pb
...
single-horse chair and madam \textit{Pompadour}’s
...
necessary to draw off\pb his forces and raise the siege somewhat
indignantly.
...
in the year 18, which was about six or seven weeks before the
time I’m speaking of.\tsh When \textit{Trim}, as his custom was,
...
but that the foul-mouth’d trumpet of\pb
Fame carried it from ear to ear, till at length it reached my
father’s, with this untoward circumstance along with it, that my
uncle \textit{Toby}’s curious draw-bridge, constructed and
...
his hu-\pb mour than any one which had yet befall’n it, it proved
...
\textit{Bridget}, I dragg’d her after\pb 
\stick{me, by means of which she fell backwards}
...
My uncle \textit{Toby} would never attempt\pb 
...
battering ram or a catapulta, I care not which,\pb
quoth my father to himself,\tsh if ever I~insult this worthy
soul more.

\section{\lsss{CHAP}.\quad  XXV.}

\lettrine{T}{\,\ls{he}} draw-bridge being held
...
as my\pb uncle \textit{Toby} took it of him in the field,\tsh
...
one\pb half of which turning to one side of the fossè, and the
...
ballance, and keeps watch as well as a\pb couple of centinels, inasmuch
...
\lettrine{W}{\,\ls{hen}} \textit{Trim} came in and told my
...
operations of my uncle \textit{Toby}’s imagination, than what he
had; so, notwithstanding the catapulta and bat\-tering-ram, and
...
\lettrine{\hskip-6pt\Tsk\!\! T}{\,\ls{his}} unfortunate draw-bridge\break
of yours, quoth my father,\tsk\break
God bless your honour, cried \textit{Trim}, ’tis a bridge for
master’s nose.\tsh In bringing him into the world with his vile
instruments, he has crush’d his nose, \textit{Susannah} says, as
...
\tsh Lead me, brothet \textit{Toby}, cried my father, to
my room this instant.

\newpage
\section{\lsss{CHAP}.\quad  XXVIII.}

\lettrine{F}{\,\ls{rom}} the first moment I sat down\break
...
I feel an abatement of the quickness of\pb
...
\lettrine{\hbox to 36pt{\Tsk I}}{\kern 4pt won't} go about to argue the\break
point with you,\tsk ’tis so,\tsk and\pb
...
it not. A fix’d, inflexible sorrow took possession of every line
...
so that you see, madam, there is but a\pb
...
\lettrine{\Tsk\rlap{\large\lqq}%
\lower-10pt\hbox{\large\lqq}\itshape A}{\itshape\ls{ll}}
\textit{is not
gain that is got into the purse}.”\tsk So that\break
notwithstanding my father had the happiness of reading the
oddest books in the universe, and had moreover, in himself, the
oddest way of thinking, that ever\pb man in it was bless’d with, yet
...
To explain this, I must leave him upon\pb the bed for half an
hour,\tsh and my good uncle \textit{Toby} in his old fringed
chair sitting beside him.

\section{\lsss{CHAP}.\quad  XXXI.}

\lettrine{\hbox to 42pt{\kern-2pt\Tsk I\,}}{\ls{think}} it a very unreasonable
demand,\tsh cried my great\break
...
Now, before I venture to make use\pb
...
word you have most occasion for,\tsh changing it, Sir, as\pb
...
volume of this book of books,\pb
...
breast,\tsh to define\tsk is to distrust.\tsh\break
...
\lettrine{\Tsk\lower-10pt\hbox{\large\lqq}B}{\lss{ecause}},\,\lower2pt\hbox{”}
quoth my\break grandmother, repeating\break
the words again,\tsk\lqq you have little or\break
\lqq no nose, Sir.\,”\tsh
...
\lettrine{\!\Tsk W}{\,\ls{hat}} an unconscionable\break
...
grandfather twelve years; so that my father\pb
had the
jointure to pay, a hundred and fifty pounds half-yearly,\tsk (on
\textit{Michaelmas} and \textit{Lady day},)\tsk during all
that\break
time.
...
with it,\tsk and seldom\pb could get to the end of the fifty
pounds, without pulling out his handkerchief, and wiping his
temples.

Defend me, gracious heaven! from 
\stick{those persecuting spirits who make no al-}
...
raise and hoist it\pb up into the best vacancies in the
...
or that part of man which stands prominent in his face,\pb
\tsk and which painters say, in good jolly\break
noses and well-proportioned faces, should\break
...
\lettrine{I}{t} is a singular blessing, that
...
that ever exist-\break ed, be whisk’d into at once, did he read\pb
...
right to this apple? \textit{ex confesso}, he will say,\tsk things
were in a state of nature,\tsk The apple, is as much
\textit{Frank}’s apple as \textit{John}’s. Pray, Mr.
\textit{Shandy}, what patent has he to shew for it? and how did it
begin to be his? was it, when he set\pb
his heart upon it? or when he gather’d it? or when he chew’d it?
or when he roasted it? or when he peel’d? or when he brought it
home? or when he digested?\tsh or when he\tsh ?\tsh For ’tis
...
\textit{Justinian}’s down to\pb the codes of \textit{Louis} and
...
By the same learned chain of reason-\pb ing my father stood up
...
own goods and chattels.\tsk Accordingly he held fast by ’em,
...
at the very same time he did it, he collected every book\pb
...
ever virtue and nature kindled in a\pb
...
\lettrine{M}{y} father’s collection was not
...
moment he laid his hands upon it.\tsk There are not three
...
lightning,\tsk took \textit{Bruscambille} into his
bosom,\tsh hyed home\pb from \textit{Piccadilly} to
...
by-standers.\tsk Take notice, I go no farther with the
simile,\tsk my father’s eye was greater than his\pb
...
\lettrine{O}{f} all the tracts my father was at
...
venerable \textit{Erasmus}, upon the various uses\pb
...
nimble as to slip on,\tsk let me beg of you, like an un\-back’d
filly, \textit{to frisk it}, 
\textit{to squirt it}, 
\textit{to jump it}, 
\textit{to rear it}, 
\textit{to bound it},\tsk 
\textit{and to kick it, with long kicks and short
...
\lettrine{\lower-10pt\hbox{\large “}\itshape N}{\enspace \itshape\lss{ihil}}
\textit{me pænitet hujus nasi},\,”\break
quoth \textit{Pamphagus};\tsk that is,\tsk\break
\stick{\lqq My nose has been the making of me.’}
...
The doctrine, you see, was laid down by \textit{Erasmus}, as
...
make nothing of it, that way. Mayhap there is more meant,
than is said in 
\stick{it, quoth my father.\tsk Learned men, bro-}
ther \textit{Toby}, don’t write dialogues upon long noses
for nothing.\tsk I’ll study the
...
\newpage
\noindent
\stick{\hfill Nature had been prodigal in her gifts to}
my father beyond measure, and had sown the seeds of verbal
...
\lettrine{O}{} \textit{Slawkenbergius!}\@ thou faithful
...
secret impulse 
\stick{was it? what intonation of voice? whence}
...
upon\pb this one work.\tsk Towards the end of his
...
his being;\tsk or,\tsk to shorten my translation, for
\textit{Slawkenbergius}’s book is in \textit{Latin}, and not
a little prolix in this passage,\tsk ever since I
understood, quoth \textit{Slawkenbergius}, any thing,\tsk or
rather \textit{what was what},\tsk and could perceive that
the point of long noses had been too loosely handled by all
who had gone before;\tsh have I, \textit{Slawkenbergius},
felt a strong impulse, with a mighty and un-\pb resistible call
...
borrowing, and stealing, as he went along, all that had\pb
...
\stick{twenty charnel houses in \textit{Silesia}, which he} had
rummaged,\tsk has informed us, that\pb the mensuration and
...
immediate tutelage of Heaven)\tsk it so\pb happens, and ever must,
...
him,\pb
\tsh but \textit{Scroderus} went on, maintaining his
thesis.\tsh
...
preceding, or succeed-\pb ing kings (I know not which)\tsk and
...
\stick{softness and flaccidity in the nurse’s breast,}\break
\stick{\tsh as the flatness and shortness of \textit{puisne}}\break
noses was, to the firmness and elastic repulsion of
the same organ of nutri-\pb tion in the hale and lively,\tsk which,
...
\noindent
\stick{\hfill And, secondly, that besides the systems} of \textit{Prignitz} and
\textit{Scroderus}, which \textit{Ambrose}\pb\textit{Paræus} his hypothesis
effectually overthrew,\tsk it overthrew at the same time the
system of peace and harmony of our family; and for three days
together, not only embroiled matters between my father and my
mother, but turn’d likewise \stick{the whole house and every thing
in}\break
\stick{it, except my uncle \textit{Toby}, quite upside} down.
...
distresses and domestic misadventures crouding in upon me\pb thick
...
\stick{there is no time to be lost in exclamations.}
...
seen in,\tsk this certainly is the greatest,\pb
...
\lettrine{T}{\,\ls{here}} was not any one scene more
...
so\-lemn,\tsh that I believe in my soul, (un-\pb less my love and
...
when my father’s imagination \stick{was heated with the enquiry, and
nothing}\pb would serve him but to heat my uncle \textit{Toby}’s
too.
...
\textit{Scroderus}’s doctrines,\tsh I say not,\tsk let
school-men,\tsk scullions, anatomists,\pb and engineers, fight for it
among themselves,\tsh
...
purest,\tsh and generally least so where ’twas most
wanted,\tsk this naturally open’d a door to a second
misfortune;\tsk that in the warmer paroxisms of his zeal
to open my uncle \textit{Toby}’s eyes,\tsh my
...
\lettrine{T}{\,\ls{he}} gift of ratiocination and making
...
great and principal\pb act of ratiocination in man, as logicians tell
...
wonder-\break ful seriousness he contemplated the length of
it,\tsk surveying it transversely as he held it betwixt his
finger and his thumb,\break\tsk then foreright,\tsk then
this way, and\pb then that, in all its possible directions and
...
\lettrine{’T}{\,is} a pity, cried my father
...
taken a turn there\pb too,\tsk so that with all the semblance
of a deep school-man intent upon the \textit{medius
terminus}\tsh my uncle \textit{Toby} was in fact as ignorant
of the whole lecture, and all its pro’s and con’s, as if my
father had been translating \textit{Hafen Slawkenbergius}
from the \textit{Latin} tongue into the \textit{Cherokeè}.
But the word \textit{siege}, like a talismanic power, in my
father’s metaphor, wafting back my uncle \textit{Toby}’s
fancy, quick as a note could follow the touch,\tsk he open’d
his ears,\tsh and my father observing that he took his pipe
...
bureau,\tsk walk’d slowly back,\tsk twisted my mother’s
...
oath of confu-\pb sion was levell’d at my uncle
...
your honours, was no more than powder to the ball.
...
earth)\tsh\break
\stick{By all that’s good and great! brother}\pb
\enlargethispage{\baselineskip}%
...
\stick{have it so.\tsk That is \textit{Grangousier}’s
solution,} said
...
infinite\break
\stick{wisdom.\tsh ’Tis a pious account, cried}\pb my father,
...
\lettrine{N}{\,o} matter,\tsk as an appendage to
seamstressy, the thread-paper might be of some consequence to my
mother,\tsk of none to my father, as a mark in \textit{Slawkenbergius.
Slawkenbergius} in every page of him was a rich treasure of
inexhaustible knowledge to my father,\tsk he could not\pb
\enlargethispage{\baselineskip}%
open him amiss; and he would often say in closing the book,
...
so glazed, so contrited\pb and attrited was it with fingers
...
of \stick{them in his eighth, ninth, and tenth decads,}
which I own seem
